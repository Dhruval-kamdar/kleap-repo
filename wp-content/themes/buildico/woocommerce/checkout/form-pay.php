...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'buildico' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'buildico' ); ?></th>
			</tr>
		</thead>
		<tbody>
	...
	<div id="payment">
		...
		<div class="form-row">
			...
			<?php echo apply_filters( 'woocommerce_pay_order_button_html', '<button type="submit" class="enova-pay-btn" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '">' . esc_html( $order_button_text ) . '</button>' ); // @codingStandardsIgnoreLine ?>
