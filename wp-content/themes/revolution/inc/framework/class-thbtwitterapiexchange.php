...
class ThbTwitterAPIExchange {
	...
	public function build_oauth( $request_url, $request_method ) {
		if ( ! in_array( strtolower( $request_method ), array( 'post', 'get' ), true ) ) {
	 ...
	 * @return string
	 */
	private function build_signature_base_string( $request_url, $method, $oauth_params ) {
	...
	public function generate_oauth_signature( $data ) {
