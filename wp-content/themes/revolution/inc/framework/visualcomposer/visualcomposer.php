...
function thb_vc_gitem_zone_image_block_link( $image_block, $link, $css_class ) {
	if ( 'image_lightbox' === $link ) {
		$image_block = '<a href="{{ post_image_url }}" title="{{ post_title }}" class="mfp-image"></a>';
	}
	return $image_block;
}
add_filter( 'vc_gitem_zone_image_block_link', 'thb_vc_gitem_zone_image_block_link', 10, 3 );
