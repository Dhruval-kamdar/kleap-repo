<table class="widefat" cellspacing="0">
	<thead>
		...
		<?php if ( function_exists( 'ini_get' ) ) : ?>
			...
			<tr>
				<td><?php esc_html_e( 'PHP Version:', 'revolution' ); ?></td>
				<td>
					<?php
					if ( function_exists( 'phpversion' ) ) {
						...
						<?php } else { ?>
							<mark class="<?php echo esc_attr( $mark ); ?>">
									...
									<?php wp_kses_post( 'Required PHP Version is at least 5.6. WordPress <a href="https://wordpress.org/about/requirements/" target="_blank">recommends using at least PHP 7.0.</a> ', 'revolution' ); ?>
							</mark>
						<?php } ?>
					<?php	} ?>
				</td>
			...
			<tr>
				<td><?php esc_html_e( 'PHP Time Limit', 'revolution' ); ?>:</td>
				<td>
					<?php
		...
		<?php endif; ?>
		<tr>
			<td><?php esc_html_e( 'Max Upload Size', 'revolution' ); ?>:</td>
			<td>
				<?php
		...
		?>
		<tr>
			<td><?php esc_html_e( 'XML Reader', 'revolution' ); ?>:</td>
			<td>
				<?php
