...
function thb_google_webfont() {
	...
	foreach ( $options as $option ) {
		...
		if ( ! empty( $array['font-family'] ) ) {
			if ( ! in_array( $array['font-family'], $thb_fontlist, true ) ) {
				if ( in_array( $array['font-family'], $google_fonts_families, true ) ) {
...
function thb_typeoutput( $array, $important = false, $default = false, $just_size = false ) {
	global $thb_fontlist;
