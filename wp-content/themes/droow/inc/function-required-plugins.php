 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme droow for publication on ThemeForest
...
add_action( 'tgmpa_register', 'droow_register_required_plugins' );
 ...
 */
function droow_register_required_plugins()
{
    ...
    $plugins = array(
        ...
        array(
            'name'     => esc_html__( 'Elementor', 'droow' ),
            'slug'     => 'elementor',
            'required' => true,
        ),
        array(
