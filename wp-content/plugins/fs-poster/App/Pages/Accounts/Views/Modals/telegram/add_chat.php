...
<div class="fsp-modal-body">
	<div class="fsp-modal-step">
		...
		<div class="fsp-form-group">
			<label><?php echo fsp__( 'Last active chats (optional)' ); ?>&emsp;<i id="fspReloadChats" class="fas fa-sync fsp-tooltip" data-title="<?php echo fsp__( 'Reload the list' ); ?>"></i></label>
