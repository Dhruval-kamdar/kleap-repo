...
trait Ajax
{
	...
	public function settings_telegram_save ()
	{
		...
		$fs_telegram_prevent_image_cache = Request::post( 'fs_telegram_prevent_image_cache', 0, 'string', [ 'on' ] ) === 'on' ? 1 : 0;
		...
		Helper::setOption( 'telegram_prevent_image_cache', $fs_telegram_prevent_image_cache );
