...
<div class="fsp-settings-row fsp-is-collapser">
	<div class="fsp-settings-collapser">
		...
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'You can customize the text of the shared post as you like by using the current keywords. Please read the <a href="https://www.fs-poster.com/documentation/instagram-empty-caption" target="_blank">Instagram content rules</a> before setting your custom message.', [], FALSE ); ?></div>
	</div>
