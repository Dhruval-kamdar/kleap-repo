...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		...
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'Telegram limits the message length to a maximum of 4096 characters. By enabling the option, the first 4096 characters of your custom message will be shared; otherwise, the post won\'t be shared because of the limit.' ); ?></div>
	</div>
	<div class="fsp-settings-col">
...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		<div class="fsp-settings-label-text"><?php echo fsp__( 'Prevent caching images' ); ?></div>
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'Telegram caches images. If you share different images with the same name, you need to enable this option.' ); ?></div>
	</div>
	<div class="fsp-settings-col">
		<div class="fsp-toggle">
			<input type="checkbox" name="fs_telegram_prevent_image_cache" class="fsp-toggle-checkbox" id="fs_telegram_prevent_image_cache" <?php echo Helper::getOption( 'telegram_prevent_image_cache', '0' ) ? 'checked' : ''; ?>>
			<label class="fsp-toggle-label" for="fs_telegram_prevent_image_cache"></label>
		</div>
	</div>
</div>
<div class="fsp-settings-row fsp-is-collapser">
	<div class="fsp-settings-collapser">
		...
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'You can customize the text of the shared post as you like by using the current keywords.<br>&lt;b&gt;<b>bold</b>&lt;/b&gt;, &lt;u&gt;<u>underlined</u>&lt;/u&gt;, &lt;i&gt;<i>italic</i>&lt;/i&gt; tags are supported.', [], FALSE ); ?></div>
	</div>
