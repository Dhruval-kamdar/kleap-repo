...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		...
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'If you don\'t want to show FS Poster <i class="far fa-question-circle fsp-tooltip"  data-title="Click to learn more" data-open-img="' . Pages::asset( 'Base', 'img/fs_poster_column_help.png' ) . '"></i> column on posts table, you can disable this option.', [], FALSE ); ?></div>
	</div>
	<div class="fsp-settings-col">
...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		<div class="fsp-settings-label-text"><?php echo fsp__( 'Custom post types' ); ?></div>
...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		...
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'The plugin appends a "feed_id" parameter to a post link to get statistics. Disabling the option prevents you from getting statistics in the Insights menu. And because the plugin does not collect statistics,  you might also have duplicate posts on Social Networks even if you select the “Randomly (without duplicates)” option when you use the schedule module.' ); ?></div>
	</div>
	<div class="fsp-settings-col">
		<div class="fsp-toggle">
...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		<div class="fsp-settings-label-text"><?php echo fsp__( 'Cron Job settings' ); ?></div>
		<div class="fsp-settings-label-subtext"><?php echo fsp__( '<a href="https://www.fs-poster.com/documentation/how-to-set-up-a-cron-job-on-wordpress-fs-poster-wp-plugin" target="_blank">The cron jobs</a> have to be configured on your website; otherwise, the auto-post and schedule features might not work punctually, and you might encounter delays.', [], FALSE ); ?></div>
	</div>
	<div class="fsp-settings-col">
		<?php
		...
		{
			echo '<span>' . fsp__( 'Not runned! Your schedule posts and background share may be not work! Please follow this <a href="https://www.fs-poster.com/documentation/how-to-set-up-a-cron-job-on-wordpress-fs-poster-wp-plugin" target="_blank">documentation</a> and configure your WordPress Cron Jobs.', [], FALSE ) . '</span>';
		}
		else
		{
			...
			if ( $calcTime > 3 )
			{
				echo '<div>' . fsp__( 'It looks like your Cron job runs with delay. Therefore your Scheduled posts and background shares may post with delay!' ) . '</div>';
			}
		}
		?>
	</div>
...
<div class="fsp-settings-row fsp-row">
	<div class="fsp-note fsp-col-12">
		<?php echo fsp__( 'The Cron Job command for your website is:' ); ?>
