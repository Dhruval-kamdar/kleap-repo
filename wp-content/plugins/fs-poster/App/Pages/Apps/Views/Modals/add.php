...
<div class="fsp-modal-body">
	<p class="fsp-modal-p">
		<?php echo fsp__( 'Type <b>%s</b>', [ implode( fsp__( '</b> and <b>' ), $fsp_params[ 'fields' ] ) ], FALSE ); ?>
	</p>
	<div class="fsp-modal-step">
		...
		<div class="fsp-form-group <?php echo $fsp_params[ 'driver' ] === 'fb' ? '' : 'fsp-hide'; ?>">
			<label><?php echo fsp__( 'The App Version' ); ?></label> <select id="fspAppVersion" class="fsp-form-select">
