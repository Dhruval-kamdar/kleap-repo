                                        ...
                                        switch($module_setting['input_type'])
                                            {
                                                case 'text' :
                                                                ...
                                                                ?><input name="<?php echo $option_name ?>" class="<?php echo $class ?>" value="<?php echo esc_html( htmlentities( $value) ) ?>" placeholder="<?php echo esc_html($module_setting['placeholder']) ?>" type="text"><?php
            ...
            function _generate_interface_tabs()
                {
                    ...
                    ?>" method="post">
                        ...
                        <input type="button" class="reset_settings button-secondary cancel alignright" value="<?php _e( "Reset All Settings", 'wp-hide-security-enhancer' ) ?>" onclick="wph_setting_reset_confirmation ();">
