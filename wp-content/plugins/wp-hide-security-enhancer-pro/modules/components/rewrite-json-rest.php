                    ...
                    $this->component_settings[]                  =   array(
                                                                    ...
                                                                    'help'          =>  array(
                                                                                                        ...
                                                                                                        'description'               =>  __("This blocks the JSON REST API service.",    'wp-hide-security-enhancer') .
                                                                                                                                            "<br ><span class='important'>" . __("This might be required by specific plugins, including WordPress <b>Gutenberg</b> editor. In such case, if you block the default, ensure you should provide a New JSON Path.",    'wp-hide-security-enhancer') . "</span>",
