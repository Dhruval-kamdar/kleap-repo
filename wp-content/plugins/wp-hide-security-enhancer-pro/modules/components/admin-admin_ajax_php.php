                    ...
                    if($this->wph->server_nginx_config   === TRUE)           
                        {
                            ...
                            $rewrite_data .= "\n         rewrite ^". untrailingslashit($home_root_path) ."__WPH_SITES_SLUG__/". $this->wph->functions->get_rewrite_base( trailingslashit( $admin_url ) . $saved_field_data, FALSE, FALSE ) ."(.*) ". $rewrite_to .'$__WPH_REGEX_MATCH_2__ last;';
