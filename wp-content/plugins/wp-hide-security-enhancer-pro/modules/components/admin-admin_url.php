            ...
            function _init_admin_url($saved_field_data)
                {
                    ...
                    if($saved_field_data    !=  $previous_url )
                        {
                            add_action( 'init', array ( __CLASS__, 'new_url_email_notice') );
            ...
            static public function new_url_email_notice()
                {
                    ...
                    $new_url =   $wph->functions->get_site_module_saved_value('admin_url',  $wph->functions->get_blog_id_setting_to_use());
                    ...
                    $message    =   __('Hello',  'wp-hide-security-enhancer') . ", \n\n" 
                                    ...
                                    . __('Additionality you can use this to recover the old login / admin links ',  'wp-hide-security-enhancer') .  ": " . site_url() . '?wph-recovery='.  $wph->functions->get_recovery_code() . "\n\n"
