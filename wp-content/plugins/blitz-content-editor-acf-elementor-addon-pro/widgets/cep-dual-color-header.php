...
class Widget_Cep_Eael_Dual_Color_Header extends \Elementor\Widget_Base {

	public function get_name() {
		return 'cep-eael-dual-color-header';
	}

	public function get_title() {
		return esc_html__( 'Content Editor: Dual Color Heading', 'essential-addons-elementor' );
	}
   ...
   public function get_categories() {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'dual_graphic_element',
			[
				'label' => __( 'Shortcode or Icon', 'elementor-pro' ),
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'dual_graphic_element' => 'eael_dch_icon_short',
					'eael_show_dch_icon_content' => 'yes'
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'eael_show_dch_icon_content' => 'yes',
					'dual_graphic_element' => 'eael_dch_icon'
				]
			]
		);
	...
	<div class="eael-dual-header">
	   ...
	   <?php if( 'yes' == $settings['eael_show_dch_icon_content'] ) : ?>
		<?php if( 'eael_dch_icon' == $settings['dual_graphic_element'] ) : ?>
			<i class="<?php echo esc_attr( $settings['eael_dch_icon'] ); ?>"></i>
	   	<?php  else: ?>
			<i class="fa <?php echo esc_attr( do_shortcode($settings['eael_dch_icon_short']) ); ?>"></i>
	   	<?php endif; ?>
		<?php endif; ?>
	</div>
	<?php endif; ?>
