...
class Widget_Cep_Counter extends \Elementor\Widget_Base {
	/**
	 * Get widget name.
	 *
	...
	public function get_title() {
		return __( 'Content Editor: Counter', 'elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'graphic_element' => 'ending_number_short',
				],
			]
		);
	...
	protected function _content_template() {
		...
		<div class="elementor-counter">
			<div class="elementor-counter-number-wrapper">
				...
				<# if ( 'ending_number_short' === settings.graphic_element ) { #>
				
				<span class="elementor-counter-number" data-duration="{{ settings.duration }}" data-to-value="{{ settings.ending_number_short }}" data-delimiter="{{ settings.thousand_separator ? settings.thousand_separator_char || ',' : '' }}">{{{ settings.starting_number }}}</span>
	...
	protected function render() {
		...
		if ( 'ending_number_short' === $settings['graphic_element'] ) {
		$ending_number = do_shortcode($settings['ending_number_short']);
		} else {
		...
		<div class="elementor-counter">
			...
			<?php if ( $settings['title'] ) : ?>
				<div class="elementor-counter-title"><?php echo do_shortcode($settings['title']); ?></div>
			<?php endif; ?>
		</div>
		<?php
	}
