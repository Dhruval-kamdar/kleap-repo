...
class Widget_Cep_Eael_Progress_Bar extends \Elementor\Widget_Base {

    public function get_name() {
		return 'cep-eael-progress-bar';
	}

	public function get_title() {
		return esc_html__( 'Content Editor: EA Progress Bar', 'essential-addons-elementor' );
	}
