...
class Widget_Cep_Icon_Box extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Content Editor: Icon Box', 'elementor' );
	}
	...
	protected function render() {
    	...
    	if ( 'icon_short' === $settings['graphic_element'] ) {
