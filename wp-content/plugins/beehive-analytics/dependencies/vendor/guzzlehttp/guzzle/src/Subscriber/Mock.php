 ...
 */
class Mock implements \Beehive\GuzzleHttp\Event\SubscriberInterface, \Countable
{
    ...
    {
        $this->factory = new \Beehive\GuzzleHttp\Message\MessageFactory();
    ...
    public function getEvents()
    {
        ...
        return ['before' => ['onBefore', \Beehive\GuzzleHttp\Event\RequestEvents::SIGN_REQUEST - 10]];
    }
    /**
    ...
    public function onBefore(\Beehive\GuzzleHttp\Event\BeforeEvent $event)
    {
        ...
        } elseif ($item instanceof \Beehive\GuzzleHttp\Exception\RequestException) {
            throw $item;
        }
        ...
        if (null !== $saveTo) {
            ...
            } elseif ($saveTo instanceof \Beehive\GuzzleHttp\Stream\StreamInterface) {
                $saveTo->write($body);
            }
        }
    ...
    public function addResponse($response)
    {
        ...
        } elseif (!$response instanceof \Beehive\GuzzleHttp\Message\ResponseInterface) {
     ...
     * @return self
     */
    public function addException(\Beehive\GuzzleHttp\Exception\RequestException $e)
    {
        $this->queue[] = $e;
        return $this;
    }
    ...
    public function addMultiple(array $items)
    {
        foreach ($items as $item) {
            if ($item instanceof \Beehive\GuzzleHttp\Exception\RequestException) {
