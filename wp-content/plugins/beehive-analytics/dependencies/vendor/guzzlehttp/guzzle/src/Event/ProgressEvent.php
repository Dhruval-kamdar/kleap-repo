 ...
 */
class ProgressEvent extends \Beehive\GuzzleHttp\Event\AbstractRequestEvent
{
     ...
     */
    public function __construct(\Beehive\GuzzleHttp\Transaction $transaction, $downloadSize, $downloaded, $uploadSize, $uploaded)
    {
