 ...
 */
abstract class AbstractTransferEvent extends \Beehive\GuzzleHttp\Event\AbstractRequestEvent
{
    /**
    ...
    {
        return !$this->transaction->response instanceof \Beehive\GuzzleHttp\Ring\Future\FutureInterface;
    }
    /**
     * Get the response.
     *
