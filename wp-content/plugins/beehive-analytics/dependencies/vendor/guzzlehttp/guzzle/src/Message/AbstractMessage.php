...
abstract class AbstractMessage implements \Beehive\GuzzleHttp\Message\MessageInterface
{
    ...
    public function setBody(\Beehive\GuzzleHttp\Stream\StreamInterface $body = null)
    {
        if ($body === null) {
     ...
     */
    public static function parseHeader(\Beehive\GuzzleHttp\Message\MessageInterface $message, $header)
    {
        static $trimmed = "\"'  \n\t\r";
        $params = $matches = [];
     ...
     */
    public static function normalizeHeader(\Beehive\GuzzleHttp\Message\MessageInterface $message, $header)
    {
     ...
     * @return string
     */
    public static function getStartLineAndHeaders(\Beehive\GuzzleHttp\Message\MessageInterface $message)
    {
     ...
     * @return string
     */
    public static function getHeadersAsString(\Beehive\GuzzleHttp\Message\MessageInterface $message)
    {
        $result = '';
     ...
     */
    public static function getStartLine(\Beehive\GuzzleHttp\Message\MessageInterface $message)
    {
        if ($message instanceof \Beehive\GuzzleHttp\Message\RequestInterface) {
            return \trim($message->getMethod() . ' ' . $message->getResource()) . ' HTTP/' . $message->getProtocolVersion();
        } elseif ($message instanceof \Beehive\GuzzleHttp\Message\ResponseInterface) {
