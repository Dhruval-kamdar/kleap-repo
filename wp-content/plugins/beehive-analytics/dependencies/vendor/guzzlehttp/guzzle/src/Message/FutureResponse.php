...
use Beehive\GuzzleHttp\Ring\Future\MagicFutureTrait;
 ...
 */
class FutureResponse implements \Beehive\GuzzleHttp\Message\ResponseInterface, \Beehive\GuzzleHttp\Ring\Future\FutureInterface
{
     ...
     */
    public static function proxy(\Beehive\GuzzleHttp\Ring\Future\FutureInterface $future, callable $onFulfilled = null, callable $onRejected = null, callable $onProgress = null)
    {
        return new \Beehive\GuzzleHttp\Message\FutureResponse($future->then($onFulfilled, $onRejected, $onProgress), [$future, 'wait'], [$future, 'cancel']);
    }
