 ...
 */
class Collection implements \ArrayAccess, \IteratorAggregate, \Countable, \Beehive\GuzzleHttp\ToArrayInterface
{
    use HasDataTrait;
    /**
    ...
    public function overwriteWith($data)
    {
        ...
        } elseif ($data instanceof \Beehive\GuzzleHttp\Collection) {
