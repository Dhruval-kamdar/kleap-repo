 ...
 */
class FnStream implements \Beehive\GuzzleHttp\Stream\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\Beehive\GuzzleHttp\Stream\StreamInterface $stream, array $methods)
    {
