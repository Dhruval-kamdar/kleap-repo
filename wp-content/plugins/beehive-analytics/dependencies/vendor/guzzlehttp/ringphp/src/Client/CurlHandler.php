...
class CurlHandler
{
    ...
    {
        return new \Beehive\GuzzleHttp\Ring\Future\CompletedFutureArray($this->_invokeAsArray($request));
    }
    /**
     * @internal
     *
    ...
    public function _invokeAsArray(array $request)
    {
        ...
        return \Beehive\GuzzleHttp\Ring\Client\CurlFactory::createResponse([$this, '_invokeAsArray'], $request, $response, $hd, $bd);
    }
