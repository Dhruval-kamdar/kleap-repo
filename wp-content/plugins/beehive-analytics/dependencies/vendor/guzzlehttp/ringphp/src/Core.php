...
namespace Beehive\GuzzleHttp\Ring;
...
class Core
{
    ...
    public static function body($message)
    {
        ...
        if ($message['body'] instanceof \Beehive\GuzzleHttp\Stream\StreamInterface) {
     ...
     * @return FutureArray
     */
    public static function proxy(\Beehive\GuzzleHttp\Ring\Future\FutureArrayInterface $future, callable $onFulfilled = null, callable $onRejected = null, callable $onProgress = null)
    {
        return new \Beehive\GuzzleHttp\Ring\Future\FutureArray($future->then($onFulfilled, $onRejected, $onProgress), [$future, 'wait'], [$future, 'cancel']);
    }
    /**
