 ...
 */
class SocketHandler extends \Beehive\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($connectionString, $level = \Beehive\Monolog\Logger::DEBUG, $bubble = \true)
    {
