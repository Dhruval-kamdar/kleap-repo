...
class SignalHandler
{
    ...
    public function registerSignalHandler($signo, $level = \Beehive\Psr\Log\LogLevel::CRITICAL, $callPrevious = \true, $restartSyscalls = \true, $async = \true)
    {
    ...
    public function handleSignal($signo, array $siginfo = null)
    {
        ...
        $level = isset($this->signalLevelMap[$signo]) ? $this->signalLevelMap[$signo] : \Beehive\Psr\Log\LogLevel::CRITICAL;
