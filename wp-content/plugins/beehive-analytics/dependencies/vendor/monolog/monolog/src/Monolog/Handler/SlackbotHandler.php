 ...
 */
class SlackbotHandler extends \Beehive\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \Beehive\Monolog\Logger::CRITICAL, $bubble = \true)
    {
