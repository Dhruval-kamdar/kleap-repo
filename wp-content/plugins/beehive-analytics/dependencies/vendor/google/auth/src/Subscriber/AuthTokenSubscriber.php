 ...
 */
class AuthTokenSubscriber implements \Beehive\GuzzleHttp\Event\SubscriberInterface
{
    /**
     * @var callable
     */
    ...
    public function onBefore(\Beehive\GuzzleHttp\Event\BeforeEvent $event)
    {
        ...
        if ($quotaProject = $this->getQuotaProject()) {
            $request->setHeader(\Beehive\Google\Auth\GetQuotaProjectInterface::X_GOOG_USER_PROJECT_HEADER, $quotaProject);
        }
    }
