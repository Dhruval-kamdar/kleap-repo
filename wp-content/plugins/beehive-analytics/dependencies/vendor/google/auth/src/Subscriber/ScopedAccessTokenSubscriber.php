 ...
 */
namespace Beehive\Google\Auth\Subscriber;
 ...
 */
class ScopedAccessTokenSubscriber implements \Beehive\GuzzleHttp\Event\SubscriberInterface
{
    use CacheTrait;
     ...
     */
    public function __construct(callable $tokenFunc, $scopes, array $cacheConfig = null, \Beehive\Psr\Cache\CacheItemPoolInterface $cache = null)
    {
    ...
    {
        return ['before' => ['onBefore', \Beehive\GuzzleHttp\Event\RequestEvents::SIGN_REQUEST]];
    }
    /**
