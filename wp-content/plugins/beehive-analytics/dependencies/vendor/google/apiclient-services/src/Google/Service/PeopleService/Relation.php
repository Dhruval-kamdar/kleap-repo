 ...
 * the License.
 */
class Google_Service_PeopleService_Relation extends \Beehive\Google_Model
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_Relation', 'Google_Service_PeopleService_Relation', \false);
