 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_Report extends \Beehive\Google_Model
{
     ...
     */
    public function setColumnHeader(\Beehive\Google_Service_AnalyticsReporting_ColumnHeader $columnHeader)
    {
     ...
     */
    public function setData(\Beehive\Google_Service_AnalyticsReporting_ReportData $data)
    {
        $this->data = $data;
    }
    /**
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_AnalyticsReporting_Report', 'Google_Service_AnalyticsReporting_Report', \false);
