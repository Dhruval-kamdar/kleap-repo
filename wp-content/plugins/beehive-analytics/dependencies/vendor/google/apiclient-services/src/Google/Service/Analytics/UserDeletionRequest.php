 ...
 * the License.
 */
class Google_Service_Analytics_UserDeletionRequest extends \Beehive\Google_Model
{
     ...
     */
    public function setId(\Beehive\Google_Service_Analytics_UserDeletionRequestId $id)
    {
        $this->id = $id;
    }
    /**
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_Analytics_UserDeletionRequest', 'Google_Service_Analytics_UserDeletionRequest', \false);
