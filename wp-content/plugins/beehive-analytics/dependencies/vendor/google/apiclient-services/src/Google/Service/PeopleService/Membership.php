 ...
 * the License.
 */
class Google_Service_PeopleService_Membership extends \Beehive\Google_Model
{
     ...
     */
    public function setContactGroupMembership(\Beehive\Google_Service_PeopleService_ContactGroupMembership $contactGroupMembership)
    {
     ...
     */
    public function setDomainMembership(\Beehive\Google_Service_PeopleService_DomainMembership $domainMembership)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_Membership', 'Google_Service_PeopleService_Membership', \false);
