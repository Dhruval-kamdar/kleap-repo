 ...
 * the License.
 */
class Google_Service_PeopleService_Event extends \Beehive\Google_Model
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_Event', 'Google_Service_PeopleService_Event', \false);
