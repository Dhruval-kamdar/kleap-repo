 ...
 * the License.
 */
class Google_Service_Analytics_CustomDataSource extends \Beehive\Google_Collection
{
     ...
     */
    public function setChildLink(\Beehive\Google_Service_Analytics_CustomDataSourceChildLink $childLink)
    {
     ...
     */
    public function setParentLink(\Beehive\Google_Service_Analytics_CustomDataSourceParentLink $parentLink)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_Analytics_CustomDataSource', 'Google_Service_Analytics_CustomDataSource', \false);
