 ...
 * the License.
 */
class Google_Service_Analytics_EntityUserLink extends \Beehive\Google_Model
{
     ...
     */
    public function setEntity(\Beehive\Google_Service_Analytics_EntityUserLinkEntity $entity)
    {
        $this->entity = $entity;
    }
    /**
     ...
     */
    public function setPermissions(\Beehive\Google_Service_Analytics_EntityUserLinkPermissions $permissions)
    {
     ...
     */
    public function setUserRef(\Beehive\Google_Service_Analytics_UserRef $userRef)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_Analytics_EntityUserLink', 'Google_Service_Analytics_EntityUserLink', \false);
