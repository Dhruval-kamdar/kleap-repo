 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_DynamicSegment extends \Beehive\Google_Model
{
    public $name;
     ...
     */
    public function setSessionSegment(\Beehive\Google_Service_AnalyticsReporting_SegmentDefinition $sessionSegment)
    {
     ...
     * @param Google_Service_AnalyticsReporting_SegmentDefinition
     */
    public function setUserSegment(\Beehive\Google_Service_AnalyticsReporting_SegmentDefinition $userSegment)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_AnalyticsReporting_DynamicSegment', 'Google_Service_AnalyticsReporting_DynamicSegment', \false);
