 ...
 * the License.
 */
class Google_Service_PeopleService_Occupation extends \Beehive\Google_Model
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_Occupation', 'Google_Service_PeopleService_Occupation', \false);
