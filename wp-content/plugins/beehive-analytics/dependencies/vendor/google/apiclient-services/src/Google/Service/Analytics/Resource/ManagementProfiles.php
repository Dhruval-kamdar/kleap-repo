 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementProfiles extends \Beehive\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Analytics_Profile
     */
    public function insert($accountId, $webPropertyId, \Beehive\Google_Service_Analytics_Profile $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_Profile
     */
    public function patch($accountId, $webPropertyId, $profileId, \Beehive\Google_Service_Analytics_Profile $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_Profile
     */
    public function update($accountId, $webPropertyId, $profileId, \Beehive\Google_Service_Analytics_Profile $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('Beehive\\Google_Service_Analytics_Resource_ManagementProfiles', 'Google_Service_Analytics_Resource_ManagementProfiles', \false);
