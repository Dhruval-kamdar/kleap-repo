 ...
 * the License.
 */
class Google_Service_PeopleService_Nickname extends \Beehive\Google_Model
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_Nickname', 'Google_Service_PeopleService_Nickname', \false);
