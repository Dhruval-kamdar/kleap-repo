 ...
 * the License.
 */
class Google_Service_PeopleService_Url extends \Beehive\Google_Model
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_Url', 'Google_Service_PeopleService_Url', \false);
