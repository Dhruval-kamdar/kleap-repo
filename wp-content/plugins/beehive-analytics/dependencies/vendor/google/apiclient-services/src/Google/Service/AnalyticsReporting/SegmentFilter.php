 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_SegmentFilter extends \Beehive\Google_Model
{
    public $not;
     ...
     */
    public function setSequenceSegment(\Beehive\Google_Service_AnalyticsReporting_SequenceSegment $sequenceSegment)
    {
     ...
     */
    public function setSimpleSegment(\Beehive\Google_Service_AnalyticsReporting_SimpleSegment $simpleSegment)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_AnalyticsReporting_SegmentFilter', 'Google_Service_AnalyticsReporting_SegmentFilter', \false);
