 ...
 * the License.
 */
class Google_Service_PeopleService_Photo extends \Beehive\Google_Model
{
    public $default;
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_Photo', 'Google_Service_PeopleService_Photo', \false);
