 ...
 * the License.
 */
class Google_Service_PeopleService_PhoneNumber extends \Beehive\Google_Model
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_PhoneNumber', 'Google_Service_PeopleService_PhoneNumber', \false);
