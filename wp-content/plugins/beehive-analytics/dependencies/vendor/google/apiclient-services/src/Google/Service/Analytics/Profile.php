 ...
 * the License.
 */
class Google_Service_Analytics_Profile extends \Beehive\Google_Model
{
    public $accountId;
     ...
     */
    public function setChildLink(\Beehive\Google_Service_Analytics_ProfileChildLink $childLink)
    {
     ...
     */
    public function setParentLink(\Beehive\Google_Service_Analytics_ProfileParentLink $parentLink)
    {
     ...
     */
    public function setPermissions(\Beehive\Google_Service_Analytics_ProfilePermissions $permissions)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_Analytics_Profile', 'Google_Service_Analytics_Profile', \false);
