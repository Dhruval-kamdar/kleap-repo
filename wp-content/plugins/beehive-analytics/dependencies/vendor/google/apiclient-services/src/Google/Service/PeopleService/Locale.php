 ...
 * the License.
 */
class Google_Service_PeopleService_Locale extends \Beehive\Google_Model
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_Locale', 'Google_Service_PeopleService_Locale', \false);
