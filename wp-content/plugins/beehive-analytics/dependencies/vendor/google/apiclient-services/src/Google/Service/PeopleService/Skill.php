 ...
 * the License.
 */
class Google_Service_PeopleService_Skill extends \Beehive\Google_Model
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_Skill', 'Google_Service_PeopleService_Skill', \false);
