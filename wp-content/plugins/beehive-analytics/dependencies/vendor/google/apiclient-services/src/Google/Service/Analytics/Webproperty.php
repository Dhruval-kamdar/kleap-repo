 ...
 * the License.
 */
class Google_Service_Analytics_Webproperty extends \Beehive\Google_Model
{
    public $accountId;
     ...
     */
    public function setChildLink(\Beehive\Google_Service_Analytics_WebpropertyChildLink $childLink)
    {
     ...
     */
    public function setParentLink(\Beehive\Google_Service_Analytics_WebpropertyParentLink $parentLink)
    {
     ...
     */
    public function setPermissions(\Beehive\Google_Service_Analytics_WebpropertyPermissions $permissions)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_Analytics_Webproperty', 'Google_Service_Analytics_Webproperty', \false);
