 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_PivotHeaderEntry extends \Beehive\Google_Collection
{
     ...
     */
    public function setMetric(\Beehive\Google_Service_AnalyticsReporting_MetricHeaderEntry $metric)
    {
        $this->metric = $metric;
    }
    /**
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_AnalyticsReporting_PivotHeaderEntry', 'Google_Service_AnalyticsReporting_PivotHeaderEntry', \false);
