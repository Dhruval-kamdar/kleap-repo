 ...
 * the License.
 */
class Google_Service_Analytics_RemarketingAudienceStateBasedAudienceDefinition extends \Beehive\Google_Model
{
     ...
     */
    public function setExcludeConditions(\Beehive\Google_Service_Analytics_RemarketingAudienceStateBasedAudienceDefinitionExcludeConditions $excludeConditions)
    {
     ...
     */
    public function setIncludeConditions(\Beehive\Google_Service_Analytics_IncludeConditions $includeConditions)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_Analytics_RemarketingAudienceStateBasedAudienceDefinition', 'Google_Service_Analytics_RemarketingAudienceStateBasedAudienceDefinition', \false);
