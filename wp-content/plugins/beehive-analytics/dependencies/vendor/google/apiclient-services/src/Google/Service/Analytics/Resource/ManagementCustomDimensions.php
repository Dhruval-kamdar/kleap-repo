 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementCustomDimensions extends \Beehive\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Analytics_CustomDimension
     */
    public function insert($accountId, $webPropertyId, \Beehive\Google_Service_Analytics_CustomDimension $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_CustomDimension
     */
    public function patch($accountId, $webPropertyId, $customDimensionId, \Beehive\Google_Service_Analytics_CustomDimension $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_CustomDimension
     */
    public function update($accountId, $webPropertyId, $customDimensionId, \Beehive\Google_Service_Analytics_CustomDimension $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customDimensionId' => $customDimensionId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('Beehive\\Google_Service_Analytics_Resource_ManagementCustomDimensions', 'Google_Service_Analytics_Resource_ManagementCustomDimensions', \false);
