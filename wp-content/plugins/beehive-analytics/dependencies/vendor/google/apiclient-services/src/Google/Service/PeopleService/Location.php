 ...
 * the License.
 */
class Google_Service_PeopleService_Location extends \Beehive\Google_Model
{
    public $buildingId;
    public $current;
    public $deskCode;
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_Location', 'Google_Service_PeopleService_Location', \false);
