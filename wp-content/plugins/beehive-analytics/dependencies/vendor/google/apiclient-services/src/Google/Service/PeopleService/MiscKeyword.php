 ...
 * the License.
 */
class Google_Service_PeopleService_MiscKeyword extends \Beehive\Google_Model
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_MiscKeyword', 'Google_Service_PeopleService_MiscKeyword', \false);
