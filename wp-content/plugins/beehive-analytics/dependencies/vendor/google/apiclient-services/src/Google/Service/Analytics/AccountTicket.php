 ...
 * the License.
 */
class Google_Service_Analytics_AccountTicket extends \Beehive\Google_Model
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_Analytics_AccountTicket', 'Google_Service_Analytics_AccountTicket', \false);
