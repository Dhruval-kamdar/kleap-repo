 ...
 * the License.
 */
class Google_Service_PeopleService_SipAddress extends \Beehive\Google_Model
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_SipAddress', 'Google_Service_PeopleService_SipAddress', \false);
