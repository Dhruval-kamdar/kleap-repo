 ...
 * the License.
 */
class Google_Service_PeopleService_Organization extends \Beehive\Google_Model
{
    public $current;
    public $department;
    public $domain;
     ...
     */
    public function setEndDate(\Beehive\Google_Service_PeopleService_Date $endDate)
    {
     ...
     * @param Google_Service_PeopleService_Date
     */
    public function setStartDate(\Beehive\Google_Service_PeopleService_Date $startDate)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_Organization', 'Google_Service_PeopleService_Organization', \false);
