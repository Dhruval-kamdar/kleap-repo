 ...
 * the License.
 */
class Google_Service_PeopleService_Interest extends \Beehive\Google_Model
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_Interest', 'Google_Service_PeopleService_Interest', \false);
