 ...
 * the License.
 */
class Google_Service_PeopleService_Name extends \Beehive\Google_Model
{
    public $displayName;
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_Name', 'Google_Service_PeopleService_Name', \false);
