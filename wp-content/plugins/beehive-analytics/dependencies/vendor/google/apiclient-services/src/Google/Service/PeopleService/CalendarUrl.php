 ...
 * the License.
 */
class Google_Service_PeopleService_CalendarUrl extends \Beehive\Google_Model
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_CalendarUrl', 'Google_Service_PeopleService_CalendarUrl', \false);
