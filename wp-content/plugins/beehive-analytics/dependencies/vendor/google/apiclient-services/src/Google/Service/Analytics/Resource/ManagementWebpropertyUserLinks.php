 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementWebpropertyUserLinks extends \Beehive\Google_Service_Resource
{
    /**
     ...
     */
    public function insert($accountId, $webPropertyId, \Beehive\Google_Service_Analytics_EntityUserLink $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_EntityUserLink
     */
    public function update($accountId, $webPropertyId, $linkId, \Beehive\Google_Service_Analytics_EntityUserLink $postBody, $optParams = array())
    {
 ...
 *  </code>
 */
\class_alias('Beehive\\Google_Service_Analytics_Resource_ManagementWebpropertyUserLinks', 'Google_Service_Analytics_Resource_ManagementWebpropertyUserLinks', \false);
