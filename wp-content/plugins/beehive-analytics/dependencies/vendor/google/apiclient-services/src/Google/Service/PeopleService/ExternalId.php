 ...
 * the License.
 */
class Google_Service_PeopleService_ExternalId extends \Beehive\Google_Model
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_ExternalId', 'Google_Service_PeopleService_ExternalId', \false);
