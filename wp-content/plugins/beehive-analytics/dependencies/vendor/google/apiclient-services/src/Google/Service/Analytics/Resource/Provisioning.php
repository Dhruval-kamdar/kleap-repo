 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_Provisioning extends \Beehive\Google_Service_Resource
{
    /**
     ...
     */
    public function createAccountTicket(\Beehive\Google_Service_Analytics_AccountTicket $postBody, $optParams = array())
    {
     ...
     */
    public function createAccountTree(\Beehive\Google_Service_Analytics_AccountTreeRequest $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('Beehive\\Google_Service_Analytics_Resource_Provisioning', 'Google_Service_Analytics_Resource_Provisioning', \false);
