 ...
 * the License.
 */
class Google_Service_Analytics_Goal extends \Beehive\Google_Model
{
    public $accountId;
    public $active;
    public $created;
     ...
     */
    public function setEventDetails(\Beehive\Google_Service_Analytics_GoalEventDetails $eventDetails)
    {
     ...
     */
    public function setParentLink(\Beehive\Google_Service_Analytics_GoalParentLink $parentLink)
    {
     ...
     */
    public function setUrlDestinationDetails(\Beehive\Google_Service_Analytics_GoalUrlDestinationDetails $urlDestinationDetails)
    {
     ...
     */
    public function setVisitNumPagesDetails(\Beehive\Google_Service_Analytics_GoalVisitNumPagesDetails $visitNumPagesDetails)
    {
     ...
     */
    public function setVisitTimeOnSiteDetails(\Beehive\Google_Service_Analytics_GoalVisitTimeOnSiteDetails $visitTimeOnSiteDetails)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_Analytics_Goal', 'Google_Service_Analytics_Goal', \false);
