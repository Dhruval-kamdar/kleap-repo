 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementRemarketingAudience extends \Beehive\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Analytics_RemarketingAudience
     */
    public function insert($accountId, $webPropertyId, \Beehive\Google_Service_Analytics_RemarketingAudience $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_RemarketingAudience
     */
    public function patch($accountId, $webPropertyId, $remarketingAudienceId, \Beehive\Google_Service_Analytics_RemarketingAudience $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_RemarketingAudience
     */
    public function update($accountId, $webPropertyId, $remarketingAudienceId, \Beehive\Google_Service_Analytics_RemarketingAudience $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'remarketingAudienceId' => $remarketingAudienceId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('Beehive\\Google_Service_Analytics_Resource_ManagementRemarketingAudience', 'Google_Service_Analytics_Resource_ManagementRemarketingAudience', \false);
