 ...
 * the License.
 */
class Google_Service_Analytics_EntityUserLinkEntity extends \Beehive\Google_Model
{
     ...
     */
    public function setAccountRef(\Beehive\Google_Service_Analytics_AccountRef $accountRef)
    {
     ...
     */
    public function setProfileRef(\Beehive\Google_Service_Analytics_ProfileRef $profileRef)
    {
     ...
     */
    public function setWebPropertyRef(\Beehive\Google_Service_Analytics_WebPropertyRef $webPropertyRef)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_Analytics_EntityUserLinkEntity', 'Google_Service_Analytics_EntityUserLinkEntity', \false);
