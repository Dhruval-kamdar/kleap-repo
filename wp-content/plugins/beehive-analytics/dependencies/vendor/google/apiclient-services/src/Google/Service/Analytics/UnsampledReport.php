 ...
 * the License.
 */
class Google_Service_Analytics_UnsampledReport extends \Beehive\Google_Model
{
     ...
     */
    public function setCloudStorageDownloadDetails(\Beehive\Google_Service_Analytics_UnsampledReportCloudStorageDownloadDetails $cloudStorageDownloadDetails)
    {
     ...
     */
    public function setDriveDownloadDetails(\Beehive\Google_Service_Analytics_UnsampledReportDriveDownloadDetails $driveDownloadDetails)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_Analytics_UnsampledReport', 'Google_Service_Analytics_UnsampledReport', \false);
