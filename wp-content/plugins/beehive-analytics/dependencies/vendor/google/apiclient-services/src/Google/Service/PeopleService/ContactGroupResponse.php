 ...
 * the License.
 */
class Google_Service_PeopleService_ContactGroupResponse extends \Beehive\Google_Model
{
     ...
     */
    public function setStatus(\Beehive\Google_Service_PeopleService_Status $status)
    {
        $this->status = $status;
    }
    /**
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_ContactGroupResponse', 'Google_Service_PeopleService_ContactGroupResponse', \false);
