 ...
 * the License.
 */
class Google_Service_PeopleService_Address extends \Beehive\Google_Model
{
    public $city;
    public $country;
    public $countryCode;
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_Address', 'Google_Service_PeopleService_Address', \false);
