 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementExperiments extends \Beehive\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Analytics_Experiment
     */
    public function insert($accountId, $webPropertyId, $profileId, \Beehive\Google_Service_Analytics_Experiment $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_Experiment
     */
    public function patch($accountId, $webPropertyId, $profileId, $experimentId, \Beehive\Google_Service_Analytics_Experiment $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_Experiment
     */
    public function update($accountId, $webPropertyId, $profileId, $experimentId, \Beehive\Google_Service_Analytics_Experiment $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'experimentId' => $experimentId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('Beehive\\Google_Service_Analytics_Resource_ManagementExperiments', 'Google_Service_Analytics_Resource_ManagementExperiments', \false);
