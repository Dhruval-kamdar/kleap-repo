 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_Segment extends \Beehive\Google_Model
{
     ...
     */
    public function setDynamicSegment(\Beehive\Google_Service_AnalyticsReporting_DynamicSegment $dynamicSegment)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_AnalyticsReporting_Segment', 'Google_Service_AnalyticsReporting_Segment', \false);
