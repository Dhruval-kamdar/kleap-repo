 ...
 * the License.
 */
class Google_Service_PeopleService_ImClient extends \Beehive\Google_Model
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_ImClient', 'Google_Service_PeopleService_ImClient', \false);
