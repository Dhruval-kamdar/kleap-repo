...
class Google_Http_MediaFileUpload
{
     ...
     */
    public function __construct(\Beehive\Google_Client $client, \Beehive\Psr\Http\Message\RequestInterface $request, $mimeType, $data, $resumable = \false, $chunkSize = \false)
    {
        $this->client = $client;
    ...
    public function nextChunk($chunk = \false)
    {
        ...
        $request = new \Beehive\GuzzleHttp\Psr7\Request('PUT', $resumeUri, $headers, \Beehive\GuzzleHttp\Psr7\stream_for($chunk));
     ...
     *
     */
    private function makePutRequest(\Beehive\Psr\Http\Message\RequestInterface $request)
    {
        ...
        return \Beehive\Google_Http_REST::decodeHttpResponse($response, $this->request);
    }
    /**
    ...
    public function resume($resumeUri)
    {
        ...
        $httpRequest = new \Beehive\GuzzleHttp\Psr7\Request('PUT', $this->resumeUri, $headers);
    ...
    private function process()
    {
        ...
        $request = $request->withUri(\Beehive\GuzzleHttp\Psr7\Uri::withQueryValue($request->getUri(), 'uploadType', $uploadType));
        ...
        $request = $request->withBody(\Beehive\GuzzleHttp\Psr7\stream_for($postBody));
    ...
    private function fetchResumeUri()
    {
        ...
        throw new \Beehive\Google_Exception($error);
    }
    private function transformToUploadUrl()
    {
        ...
        $uri = \Beehive\GuzzleHttp\Psr7\Uri::fromParts($parts);
 ...
 * of sizable data.
 */
\class_alias('Beehive\\Google_Http_MediaFileUpload', 'Google_Http_MediaFileUpload', \false);
