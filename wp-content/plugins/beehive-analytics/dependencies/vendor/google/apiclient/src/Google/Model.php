...
class Google_Model implements \ArrayAccess
{
    ...
    {
        if ($value instanceof \Beehive\Google_Model) {
    ...
    {
        if ($obj && !\is_array($obj)) {
            throw new \Beehive\Google_Exception("Incorrect parameter type passed to {$method}(). Expected an array.");
        }
    }
 ...
 *
 */
\class_alias('Beehive\\Google_Model', 'Google_Model', \false);
