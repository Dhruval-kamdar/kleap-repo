...
class Promise implements \Beehive\React\Promise\ExtendedPromiseInterface, \Beehive\React\Promise\CancellablePromiseInterface
{
    private $canceller;
    private $result;
    private $handlers = [];
    ...
    public function done(callable $onFulfilled = null, callable $onRejected = null, callable $onProgress = null)
    {
        ...
        $this->handlers[] = static function (\Beehive\React\Promise\ExtendedPromiseInterface $promise) use($onFulfilled, $onRejected) {
    ...
    private function resolver(callable $onFulfilled = null, callable $onRejected = null, callable $onProgress = null)
    {
        return function ($resolve, $reject, $notify) use($onFulfilled, $onRejected, $onProgress) {
            ...
            $this->handlers[] = static function (\Beehive\React\Promise\ExtendedPromiseInterface $promise) use($onFulfilled, $onRejected, $resolve, $reject, $progressHandler) {
    ...
    private function settle(\Beehive\React\Promise\ExtendedPromiseInterface $promise)
    {
        $promise = $this->unwrap($promise);
        if ($promise === $this) {
            $promise = new \Beehive\React\Promise\RejectedPromise(new \LogicException('Cannot resolve a promise with itself.'));
        }
    ...
    {
        if ($promise instanceof \Beehive\React\Promise\LazyPromise) {
