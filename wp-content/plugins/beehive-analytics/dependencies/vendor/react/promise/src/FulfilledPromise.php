 ...
 */
class FulfilledPromise implements \Beehive\React\Promise\ExtendedPromiseInterface, \Beehive\React\Promise\CancellablePromiseInterface
{
    private $value;
    public function __construct($value = null)
    {
        if ($value instanceof \Beehive\React\Promise\PromiseInterface) {
