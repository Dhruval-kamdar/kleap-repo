 ...
 */
class LazyPromise implements \Beehive\React\Promise\ExtendedPromiseInterface, \Beehive\React\Promise\CancellablePromiseInterface
{
    private $factory;
    private $promise;
    ...
    public function promise()
    {
        if (null === $this->promise) {
            try {
                ...
                $this->promise = new \Beehive\React\Promise\RejectedPromise($exception);
