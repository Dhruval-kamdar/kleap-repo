 ...
 * @access  public
 */
class TripleDES extends \Beehive\phpseclib\Crypt\DES
{
    /**
     ...
     */
    const MODE_CBC3 = \Beehive\phpseclib\Crypt\Base::MODE_CBC;
    /**
     * Key Length (in bytes)
     *
     ...
     * @access public
     */
    function __construct($mode = \Beehive\phpseclib\Crypt\Base::MODE_CBC)
    {
        switch ($mode) {
            // In case of self::MODE_3CBC, we init as CRYPT_DES_MODE_CBC
            // and additional flag us internally as 3CBC
            case self::MODE_3CBC:
                parent::__construct(\Beehive\phpseclib\Crypt\Base::MODE_CBC);
                $this->mode_3cbc = \true;
                // This three $des'es will do the 3CBC work (if $key > 64bits)
                $this->des = array(new \Beehive\phpseclib\Crypt\DES(\Beehive\phpseclib\Crypt\Base::MODE_CBC), new \Beehive\phpseclib\Crypt\DES(\Beehive\phpseclib\Crypt\Base::MODE_CBC), new \Beehive\phpseclib\Crypt\DES(\Beehive\phpseclib\Crypt\Base::MODE_CBC));
