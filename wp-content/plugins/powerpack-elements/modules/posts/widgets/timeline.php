...
class Timeline extends Posts_Base {
	...
	protected function register_style_connector_controls() {
		...
		$this->start_controls_tab( 'tab_connector_normal', array( 'label' => __( 'Normal', 'powerpack' ) ) );
		...
		$this->start_controls_tab( 'tab_connector_progress', array( 'label' => __( 'Progress', 'powerpack' ) ) );
