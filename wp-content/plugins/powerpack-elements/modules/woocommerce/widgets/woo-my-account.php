...
class Woo_My_Account extends Powerpack_Widget {
	...
	/**
	 * Retrieve the list of scripts the woo my account widget depended on.
	 *
	...
	protected function register_style_controls_buttons() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units'  => array( 'px' ),
				'description' => __( 'Use the spacing setting when there are more than 1 action button under the Order Table action column.', 'powerpack' ),
				'selectors'   => array(
