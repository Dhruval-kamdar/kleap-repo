...
/*  Copyright 2014-2018  Wordpress Ranker   (email : sweetheatmn@gmail.com) */

define("WP_RANKIE_ELEMENTS",   false );

update_option('wp_rankie_license_active', 'active');
update_option('wp_rankie_license_active_date', time('now'));
update_option('wp_rankie_license','prowebber');
// UPDATES
		require 'plugin-updates/plugin-update-checker.php';
		$wp_rankie_UpdateChecker = Puc_v4_Factory::buildUpdateChecker(
