<?php
if (! function_exists ( 'deandev_add_dashboard_widgets' )  && ! WP_RANKIE_ELEMENTS) {
	...
	<tbody>
		<tr>
			...
			<td>
				...
				<p>
					The plugin includes free support. Got a problem? Don’t worry, we have a help desk setup just for your help. Submit a <a href="https://deandev.com/support">support ticket</a> and we always happy to help make you happy choosing our plugin.
				</p>
				<p>
					<a href="https://deandev.com/support" class="button"> Open a Support Ticket Now </a>
				</p>
