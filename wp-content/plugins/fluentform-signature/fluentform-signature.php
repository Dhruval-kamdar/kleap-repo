<?php
/*
Plugin Name: FluentFrom Signature
Description: The signature field for FluentFrom, the most advanced drag and drop form builder plugin for WordPress.
Version: 3.5.6
Author: WPFluentForm
Author URI: https://wpfluentform.com
Plugin URI: https://wpfluentform.com/downloads/fluentform-signature-add-on/
...
define('FLUENTFORM_SIGNATURE_VERSION', '3.5.6');
