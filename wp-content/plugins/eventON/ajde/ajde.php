	...
	// backender
		...
		// registering
			public function register_backender_styles(){
				...
				wp_register_style( 'colorpicker_styles',EVO()->assets_path.'lib/colorpicker/colorpicker_styles.css','',$this->version);
				wp_register_style( 'ajde_wp_admin',$this->path.'ajde-wp-admin.css','',$this->version);			
			}

			public function register_backender_scripts(){
				wp_register_script('backender_colorpicker',EVO()->assets_path.'lib/colorpicker/colorpicker.js' ,array('jquery'),$this->version, true);
