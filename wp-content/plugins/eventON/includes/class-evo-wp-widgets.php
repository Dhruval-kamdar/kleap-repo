				...
				echo EVO()->elements->process_multiple_elements(
					...
					array(
						...
						array(
							...
							'value'=> $fixed_month,'max'=>12,'min'=>1, 'step'=>1,
							'name'=> __('Fixed month number'),
						),	
						array(
							'type'=>'text', 'field_type'=>'number',
							'id' => $this->get_field_name('fixed_year'),
							'value'=> $fixed_year, 'max'=>3000,'min'=>1900, 'step'=>1,
							'default'=> 2020,
		...
		function form($instance) {
			...
			<div id='eventon_widget_settings' class='eventon_widget_settings'>
				...
				<div class='evo_widget_outter evowig'>
					...
					$evo_wig_ett_1 = !empty($evo_wig_ett_1) && is_array($evo_wig_ett_1)? implode(',', $evo_wig_ett_1): $evo_wig_ett_1;
					$evo_wig_ett_2 = !empty($evo_wig_ett_2) && is_array($evo_wig_ett_2)? implode(',', $evo_wig_ett_2): $evo_wig_ett_2;
