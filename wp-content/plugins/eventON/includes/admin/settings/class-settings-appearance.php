			...
			array(
				...
				array('id'=>'evcal_fcx','type'=>'hiddensection_open','name'=>__('General Calendar','eventon'), 'display'=>'none'),
					...
					array('id'=>'evo','type'=>'fontation','name'=>__('Show more events bar','eventon'),
						'variations'=>array(
							array('id'=>'evo_001a', 'name'=>__('Background Color','eventon'),'type'=>'color', 'default'=>'e6e6e6'),
				...
				array('id'=>'evcal_fcx','type'=>'hiddensection_open','name'=>__('EventTop Styles','eventon'), 'display'=>'none'),
					...
					array('id'=>'fs_fonti','type'=>'fontation','name'=>__('Background Color','eventon'),
						'variations'=>array(
							array('id'=>'evcal__bgc4', 'name'=>'Default State', 'type'=>'color', 'default'=>'ffffff'),
				...
				array('id'=>'evcal__bc1H','type'=>'color','name'=>__('Event Card Background Color (Hover on clickable section)','eventon'), 'default'=>'fffbed'),			
				array('id'=>'evcal__evcbrb','type'=>'color','name'=>__('Event Card Border Color','eventon'), 'default'=>'f1f1f1'),
