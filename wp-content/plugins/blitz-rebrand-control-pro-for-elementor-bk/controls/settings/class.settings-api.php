...
/**
 * WordPress settings API for Granular Controls For Elementor
 *
 * @author Zulfikar Nore
 */
 
if ( !class_exists( 'Granular_Settings_API' ) ) {
	class Granular_Settings_API {
		 ...
		 * @param array   $args settings field args
		 */
		function callback_checkboxui( $args ) {
		...
		function callback_file( $args ) {
			...
			$label = isset( $args['options']['button_label'] ) ? $args['options']['button_label'] : __( 'Choose File', 'blitz-controls-for-elementor' );
