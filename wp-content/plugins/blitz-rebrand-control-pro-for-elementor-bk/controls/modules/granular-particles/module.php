...
class Module extends Module_Base {
	...
	public function register_controls( $element, $section_id, $args ) {
		...
		$element->add_control(
			...
			[
				'label' => __( 'Enable Particles', 'blitz-controls-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'label_on' => 'Yes',
				'label_off' => 'No',
				'return_value' => 'yes',
				'description' => __( 'Switch on to enable & access Particles options! Note that currently particles are not visible in edit/preview mode & can only be viewed on the frontend.', 'blitz-controls-for-elementor' ),
			]
		);
		...
		$element->add_responsive_control(
			...
			[
				'label' => __( 'Height', 'blitz-controls-for-elementor' ),
				'type' => Controls_Manager::NUMBER,
				'condition' => [
					'section_particles_on' => 'yes',
				],
				'description' => __( 'Set this equal to the set Minimum Height of your section - default is 400px!', 'blitz-controls-for-elementor' ),
			]
		);
		...
		$element->add_control(
			...
			[
				'label' => __( 'Particles JSON', 'blitz-controls-for-elementor' ),
				'type' => Controls_Manager::TEXTAREA,
				'condition' => [
					'section_particles_on' => 'yes',
				],
				'description' => __( 'Paste your particles JSON code here - Generate it from <a href="http://vincentgarreau.com/particles.js/#default" target="_blank">Here!</a>', 'blitz-controls-for-elementor' ),
				'default' => '',
			]
		);
