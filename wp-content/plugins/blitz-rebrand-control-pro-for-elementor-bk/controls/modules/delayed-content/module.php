...
class Module extends Module_Base {
	...
	public function register_controls( $element, $section_id, $args ) {
		...
		$element->start_controls_section(
			...
			[
				'label' => __( 'Delayed Content', 'blitz-controls-for-elementor' ),
		...
		$element->add_control(
			'section_delay_on',
			[
				'label' => __( 'Delay Content?', 'blitz-controls-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'label_on' => 'Yes',
				'label_off' => 'No',
				'return_value' => 'yes',
				'description' => __( 'Switch on to delay the contents of this column|section!.', 'blitz-controls-for-elementor' ),
			]
		);
		...
		$element->add_control(
			...
			[
				...
				'description' => __( 'Set delay time in in minutes i.e 1 for 1 minute or 0.20 (60*0.2) for 12 seconds - default is 0.50 (30 seconds)!', 'blitz-controls-for-elementor' ),
			]
		);
