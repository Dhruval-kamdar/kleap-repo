...
class Module extends Module_Base {
	...
	public function register_controls( $element, $section_id, $args ) {
		...
		$element->start_controls_section(
			...
			[
				'label' => __( 'Schedule Content', 'blitz-controls-for-elementor' ),
		...
		$element->add_control(
			...
			[
				'raw' => __( 'These controls only affect the Column|Section they are attached to!', 'blitz-controls-for-elementor' ),
		...
		$element->add_control(
			...
			[
				...
				'label_off' => 'No',
				'return_value' => 'yes',
				'description' => __( 'Switch on to schedule the contents of this column|section!.', 'blitz-controls-for-elementor' ),
			]
		);
		...
		$element->add_control(
			'schedule_start_date',
			[
				'label' => __( 'Start Date', 'blitz-controls-for-elementor' ),
				'type' => Controls_Manager::DATE_TIME,
				'default' => $this->current_date_time(),
				'condition' => [
					'scheduled_content_on' => 'yes',
				],
				'description' => __( 'Set content display schedule start date!', 'blitz-controls-for-elementor' ),
			]
		);
		...
		$element->add_control(
			'schedule_end_date',
			[
				'label' => __( 'End Date', 'blitz-controls-for-elementor' ),
				'type' => Controls_Manager::DATE_TIME,
				'default' => '01/01/2019 00:00:00',
				'condition' => [
					'scheduled_content_on' => 'yes',
				],
				'description' => __( 'Set content display schedule end date!', 'blitz-controls-for-elementor' ),
			]
		);
