<?php
namespace ElementorControls\Base;
...
abstract class Module_Base {
	...
	public function __clone() {
		...
		_doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'blitz-controls-for-elementor' ), '1.0.0' );
	}
	...
	public function get_assets_url() {
		return ELEMENTOR_CONTROLS_MODULES_URL . $this->get_name() . '/assets/';
	}
