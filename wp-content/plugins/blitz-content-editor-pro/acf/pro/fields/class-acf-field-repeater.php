...
<table class="acf-table">
	...
	<tbody>
		...
		foreach( $value as $i => $row ): ?>
			<tr class="acf-row<?php if( $i === 'acfcloneindex' ){ echo ' acf-clone'; } ?> test" data-id="<?php echo $i; ?>">
				...
				<?php foreach( $sub_fields as $sub_field ): 
					...
					if( isset($row[ $sub_field['key'] ]) ) {
						...
						if(isset($_GET['post'])) {
						$sub_field['instructions'] = '<small>['. ( CEACFGroup::$ceshortcode_identifier) .' page={pagenum} type='.$sub_field['key'].' item='.$_GET['post'].'_'.$i.']</small>';
						} else {
							
							if($sub_field['key'] == 'medimage' || $sub_field['key'] == 'contentimage' || $sub_field['key'] == 'contentimage1' || $sub_field['key'] == 'contentimage2' || $sub_field['key'] == 'contentimage3' || $sub_field['key'] == 'testiimage') {
								$sub_field['instructions'] = '<small>['. ( CEACFGroup::$ceshortcode_identifier) .' page={pagenum} type='.$sub_field['key'].' item='.$i.' id='.$sub_field['value'].']</small>';
							} else {
								$sub_field['instructions'] = '<small>['. ( CEACFGroup::$ceshortcode_identifier) .' page={pagenum} type='.$sub_field['key'].' item='.$i.']</small>';
							}
						}
