 ...
 * @subpackage The_Wu_Integration/public
 */
...
class The_Wu_Integration_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 
			$this->plugin_name, 
			plugin_dir_url( __FILE__ ) . 'css/the-wu-integration-public.css', 
			array(), 
			$this->version, 
			'all' 
		);
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 
			$this->plugin_name, 
			plugin_dir_url( __FILE__ ) . 'js/the-wu-integration-public.js', 
			array( 'jquery' ), 
			$this->version, 
			false 
		);
