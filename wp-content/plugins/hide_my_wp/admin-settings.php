...
$fields['general'] =
    ...
    ,
        array(
            ...
            'desc' => __( 'Enables hiding from online detectors (disable if you use more than one domain)', self::slug ),
            'type' => 'checkbox',
            'default' => '',
            'class' =>'permalink_req'
        )
...
$fields['permalink'] = array(
    ...
    array(
            ...
            'desc' => __( 'Automatically hide popular plugins (woocommerce, gravity forms, jetpack, wprocket)', self::slug ),
            'type' => 'checkbox',
            'default' => '',
            'class' =>' permalink_req'
        ),
 ...
 */
    ...
    ,
        array(
            ...
            'desc' => __( 'Replace _wpnonce in URLs with _nonce. <br/><b>Note:</b> its not compatible with all themes / plugins', self::slug ),
            'type' => 'checkbox',
            'default' => '',
            'class' =>''
        ),
