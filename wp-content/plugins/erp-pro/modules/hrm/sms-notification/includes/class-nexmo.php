 ...
 * @since 1.0
 */
class Nexmo implements Gateway_Interface{
    ...
    public function get_credentials() {
        $this->apikey = erp_get_option( 'erp_sms_nexmo_apikey' );
        $this->apisecret = erp_get_option( 'erp_sms_nexmo_apisecret' );
        $this->from = erp_get_option( 'erp_sms_nexmo_sender_id' );
    }
