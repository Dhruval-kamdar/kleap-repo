...
class Smsglobal implements Gateway_Interface{
    ...
    public function get_credentials() {
        $this->username = erp_get_option( 'erp_sms_smsglobal_username' );
        $this->password = erp_get_option( 'erp_sms_smsglobal_password' );
        $this->from     = erp_get_option( 'erp_sms_smsglobal_from' );
    }
