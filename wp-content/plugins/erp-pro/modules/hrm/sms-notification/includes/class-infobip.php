 ...
 * @since 1.0
 */
class Infobip implements Gateway_Interface{
    ...
    public function get_credentials() {
        $this->username = erp_get_option( 'erp_sms_infobip_username' );
        $this->password = erp_get_option( 'erp_sms_infobip_password' );
        $this->sender   = erp_get_option( 'erp_sms_infobip_sender' );
    }
