...
class Clickatell implements Gateway_Interface{
    ...
    public function get_credentials() {
        $this->username = erp_get_option( 'erp_sms_clickatell_username' );
        $this->password = erp_get_option( 'erp_sms_clickatell_password' );
        $this->api_id   = erp_get_option( 'erp_sms_clickatell_api_id' );
    }
