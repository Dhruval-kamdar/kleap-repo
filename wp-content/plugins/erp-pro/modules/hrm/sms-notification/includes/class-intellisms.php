 ...
 * @since 1.0
 */
class Intellisms implements Gateway_Interface{
    ...
    public function get_credentials() {
        $this->username = erp_get_option( 'erp_sms_intellisms_username' );
        $this->password = erp_get_option( 'erp_sms_intellisms_password' );
        $this->sender   = erp_get_option( 'erp_sms_intellisms_sender' );
    }
