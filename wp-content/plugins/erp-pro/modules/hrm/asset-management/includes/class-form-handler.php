...
class Form_Handler {
    ...
    public function asset_bulk_action() {
        ...
        $assets_table = new \WeDevs\ERP\HRM\Asset\Assets_List_Table();
    ...
    public function asset_allottment_page() {
        ...
        $assets_table = new \WeDevs\ERP\HRM\Asset\Allottment_List_Table();
        $action       = $assets_table->current_action();
        if ( $action ) {
    ...
    public function asset_request_page() {
        ...
        $request_table = new \WeDevs\ERP\HRM\Asset\Request_List_Table();
