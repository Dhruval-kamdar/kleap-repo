...
<div class="postbox leads-actions erp-hr-employee-assets-add">
    <div class="handlediv" title="<?php _e( 'Click to toggle', 'erp-pro' ); ?>"><br></div>
    <h3 class="hndle"><span><?php _e( 'Assets', 'erp-pro' ); ?></span></h3>
    <div class="inside">
...
<div class="postbox leads-actions erp-hr-employee-assets-request">
    <div class="handlediv" title="<?php _e( 'Click to toggle', 'erp-pro' ); ?>"><br></div>
    <h3 class="hndle"><span><?php _e( 'Assets Requests', 'erp-pro' ); ?></span></h3>
    <div class="inside">
