...
class Admin_Menu {
    ...
    public function enqueue_scripts( $hook ) {
        ...
        wp_enqueue_script( 'erp-wf-scripts', ERP_WORKFLOW_ASSETS . '/js/erp-workflow' . $suffix . '.js', ['erp-vuejs', 'erp-momentjs', 'erp-sweetalert'], false, true );
    ...
    public function screen_option() {
        ...
        $this->workflows_list_table_obj = new Workflows_List_Table();
    }
