...
function send_email_notification( $emp_id ) {
    $dm_notification_email = wperp()->emailer->get_email( 'DM_File_Share_Notification' );
...
function get_file_dir_options() {
    $options                = [];
    $is_dropbox_enable      = get_option( "enable_dropbox", "yes" );
    $is_local_dir__enable   = get_option( "enable_local_directory", "yes" );
