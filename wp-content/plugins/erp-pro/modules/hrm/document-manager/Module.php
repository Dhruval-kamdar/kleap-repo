...
class Module {
    ...
    */
    ...
    public function includes() {
        ...
        require_once WPERP_DOC_INCLUDES . '/api/class-documents-controller.php';
        require_once WPERP_DOC_INCLUDES . '/class-updates.php';
        require_once WPERP_DOC_INCLUDES . '/emails/class-emails.php';
        require_once WPERP_DOC_INCLUDES . '/emails/class-email-dm-file-share-notification.php';
    ...
    public function init_classes() {
        ...
        new \WeDevs\ERP\HRM\ERP_Document\Updates();
        new \WeDevs\ERP\ERP_Document\Emails\Emailer();
    }
    ...
    public function load_rest_controller( $controllers ) {
        $controllers[] = '\WeDevs\ERP\HRM\DOC\API\Document_Controller';
