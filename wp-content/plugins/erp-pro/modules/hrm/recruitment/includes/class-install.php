...
class WeDevs_ERP_Recruitment_Installer {
	...
	public function activate_rec_now() {
		...
		if ( ! class_exists( '\WeDevs\ERP\Recruitment\Updates' ) ) {
			include_once WPERP_REC_INCLUDES . '/class-updates.php';
		}
		$updater = new \WeDevs\ERP\Recruitment\Updates();
    ...
    private function populate_email_contents() {
        $default_email_content_for_new_job_application = [
            ...
            'body'    => '
                        ...
                        {applicant_name} has applied for the position of {position} at {date}.
