...
class Admin_Menu {
    ...
    public function single_job_content( $content ) {
        ...
        if ( $post->post_type == $this->post_type ) {
            ...
            include apply_filters( 'modify_rec_single_template', $default_template );
    ...
    public function do_metaboxes() {
        ...
        add_meta_box( 'erp-hr-recruitment-schema-meta-box', __( 'Recruitment Schema Settings <span style="font-size: 12px;">( Optional )</span>', 'erp-pro' ),
            array( $this, 'meta_boxes_schema_cb' ), $this->post_type, 'advanced', 'low' );
    ...
    public function meta_boxes_cb( $post_id ) {
        ...
        <tr>
                <td width="50%">
                    <label><?php _e( 'Department', 'erp-pro' ); ?></label> <select name="department" class="full-regular-text">
            ...
            <tr>
                <td width="50%">
                    <label><?php _e( 'Minimum Experience', 'erp-pro' ); ?></label> <select name="minimum_experience" class="full-regular-text">
                        <option></option><?php
            ...
            <tr>
                <td width="50%">
                   <?php erp_html_form_input(
                        array( 'label' => __( 'Submission Deadline', 'erp-pro' ),
                               'name'  => 'expire_date', 'value' => ( $get_expire_date == "" ) ? '' : $get_expire_date,
                               'type'  => 'text', 'class' => 'erp-date-field-expire-date full-regular-text' )
                    );
                    ?>
                </td>
                <td width="50%">
    ...
    public function meta_boxes_schema_cb( $post_id ) {
        ...
        <tr>
            <td width="50%">
                <?php erp_html_form_input(
                    array( 'label' => __( 'Street Address', 'erp-pro' ),
                        'name'  => 'street_address', 'value' => ( $street_address == "" ) ? '' : $street_address,
                        'type'  => 'text', 'class' => 'full-regular-text' )
                );
                ?>
            </td>
            <td width="50%">
                <?php erp_html_form_input(
                    array( 'label' => __( 'Salary', 'erp-pro' ),
                        'name'  => 'salary', 'value' => ( $salary == "" ) ? '' : $salary,
                        'type'  => 'number', 'class' => 'full-regular-text' )
                );
                ?>
            </td>
        </tr>
        ...
        <tr>
            <td width="50%">
                <?php erp_html_form_input(
                    array( 'label' => __( 'Locality', 'erp-pro' ),
                        'name'  => 'address_locality', 'value' => ( $address_locality == "" ) ? '' : $address_locality,
                        'type'  => 'text', 'class' => 'full-regular-text' )
                );
                ?><br>
            ...
            <td width="50%">
                <?php erp_html_form_input(
                    array( 'label' => __( 'Currency', 'erp-pro' ),
                        'name'  => 'currency', 'value' => ( $currency == "" ) ? '' : $currency,
                        'type'  => 'select', 'class' => 'full-regular-text',
        ...
        <tr>
            <td width="50%">
                <?php erp_html_form_input(
                    array( 'label' => __( 'Postal Code', 'erp-pro' ),
                        'name'  => 'postal_code', 'value' => ( $postal_code == "" ) ? '' : $postal_code,
                        'type'  => 'text', 'class' => 'full-regular-text' )
                );
                ?>
            </td>
            <td width="50%">
                <?php erp_html_form_input(
                    array( 'label' => __( 'Salary Type', 'erp-pro' ),
                        'name'   => 'salary_type', 'value' => ( $salary_type == "" ) ? '' : $salary_type,
                        'type'   => 'select', 'class' => 'full-regular-text',
                        'options' => [
                            'HOUR'  => 'HOURLY',
                            'DAY'   => 'DAILY',
        ...
        <tr>
            <td width="50%">
                ...
                <?php erp_html_form_input(
                    array( 'label' => __( 'Country', 'erp-pro' ),
                        'name'  => 'address_country', 'value' => ( $address_country == "" ) ? '' : $address_country,
                        'type'  => 'select', 'class' => 'full-regular-text',
    ...
    public function admin_menu_after_1_4_0(){
        ...
        erp_add_submenu( 'hr', 'recruitment', array(
                    ...
                    ?>
                        <div class="wrap job-opening-wrap">
                            ...
                            <form method="post">
                                ...
                                <?php
                                $job_opening_table = new \WeDevs\ERP\Recruitment\Recruitment();
