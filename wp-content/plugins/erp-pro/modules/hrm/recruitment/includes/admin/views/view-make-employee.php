        ...
        <h1><?php _e( 'Fill below fields to make him an employee', 'erp-pro' ); ?></h1>
            ...
            <form id="make_him_employee_form_id" method="post">
                <table class="form-table">
                    ...
                    <tr>
                        <th>
                            <label><?php _e( 'Employment Type', 'erp-pro' ); ?></label>
                        </th>
                        <td>
                            <?php
                    ...
                    <tr>
                        <th>
                            <label><?php _e( 'Source of Hire', 'erp-pro' ); ?></label>
                        </th>
                        <td>
                            <?php erp_html_form_input( array(
                                'label'    => __( '', 'erp-pro' ),
                    ...
                    <tr>
                        <th>
                            <label><?php _e( 'Reporting To', 'erp-pro' ); ?></label>
                        </th>
                        <td>
                            <?php erp_html_form_input( array(
                                'label'    => __( '', 'erp-pro' ),
                    ...
                    <tr>
                        <th>
                            <label><?php _e( 'Employee Status', 'erp-pro' ); ?></label>
                        </th>
                        <td>
                            <?php erp_html_form_input( array(
                                'label'    => __( '', 'erp-pro' ),
                    ...
                    <tr>
                        <th>
                            <label><?php _e( 'Date of Hire', 'erp-pro' ); ?></label>
                        </th>
                        <td>
                            <?php erp_html_form_input( array(
                                'label'    => __( '', 'erp-pro' ),
                    ...
                    <tr>
                        <th>
                            <label><?php _e( 'Date of Birth', 'erp-pro' ); ?></label>
                        </th>
                        <td>
                            <?php erp_html_form_input( array(
                                'label'    => __( '', 'erp-pro' ),
                    ...
                    <tr>
                        <th>
                            <label><?php _e( 'Gender', 'erp-pro' ); ?></label>
                        </th>
                        <td>
                            <?php erp_html_form_input( array(
                                'label'    => __( '', 'erp-pro' ),
