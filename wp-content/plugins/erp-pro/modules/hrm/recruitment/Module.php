...
class Module {
    ...
    */
    ...
    public function includes() {
        ...
        require_once WPERP_REC_INCLUDES . '/class-job-schema-manager.php';
        require_once WPERP_REC_INCLUDES . '/api/class-recruitment-controller.php';

        require_once WPERP_REC_INCLUDES . '/emails/class-emails.php';
        require_once WPERP_REC_INCLUDES . '/emails/class-email-after-new-application-submission.php';
        require_once WPERP_REC_INCLUDES . '/emails/class-email-after-new-application-submission-to-applicant.php';
    ...
    public function instantiate() {
        ...
        new \WeDevs\ERP\Recruitment\JobSchemaManager();
        new \WeDevs\ERP\Recruitment\Recruitment_Controller();
        new \WeDevs\ERP\HRM\ERP_Recruitment\Emailer();
    }
    ...
    public function load_recruitment_api_controller( $controllers ){
        $controllers[] = 'WeDevs\ERP\Recruitment\Recruitment_Controller';
        return $controllers;
    }
