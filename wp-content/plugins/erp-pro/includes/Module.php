...
final class Module {
    ...
    public function get_all_modules() {
        if ( ! $this->erp_pro_modules ) {
            $thumbnail_dir = ERP_PRO_PLUGIN_ASSEST . '/images/modules';
            ...
            $this->erp_pro_modules = apply_filters( 'wp_erp_pro_modules', [
                ...
                'inventory' => [
                    ...
                    'module_class'  => '\weDevs\ERP_PRO\ACC\Inventory\Module',
                    'is_pro'        => false,
                    'is_hrm'        => false,
                    'is_crm'        => false,
                    'is_acc'        => true,
                ...
                'payment_gateway' => [
                    ...
                    'module_class'  => '\weDevs\ERP_PRO\ACC\PaymentGateway\Module',
                    'is_pro'        => false,
                    'is_hrm'        => false,
                    'is_crm'        => false,
                    'is_acc'        => true,
                ...
                'woocommerce' => [
                    ...
                    'module_class'  => '\weDevs\ERP_PRO\ACC\woocommerce\Module',
                    'is_pro'        => false,
                    'is_hrm'        => false,
                    'is_crm'        => false,
                    'is_acc'        => true,
    ...
    public function activate_modules( $modules ) {
        ...
        $modules_to_active = [];
        $error_obj = new ERP_Errors( 'erp_pro_extension_error' );
        ...
        foreach ( $modules as $module_id ) {
            ...
            if ( ! empty( $msg ) ) {
                $error = new \WP_Error( 'inactive_module', $msg );
                $error_obj->add( $error );
                continue;
            }
