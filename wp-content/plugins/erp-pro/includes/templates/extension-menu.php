...
<div class="wrap">
    <div class="wrap_head">
        <div class="page_title">
            <h1><?php esc_html_e( 'Modules & Extensions', 'erp-pro' ); ?></h1>
        </div>
            ...
            <div class="module_items">
                <div class="module_item_col">
                    <div class="module_item hrm">
                        <div class="icon">
                            <img src="<?php echo esc_url( ERP_PRO_PLUGIN_ASSEST . '/images/icons/hrm.svg' ); ?>" alt="<?php echo esc_attr( 'HRM' ); ?>" />
                        </div>
                        <h3 class="title"><?php esc_html_e( 'HR Management', 'erp-pro' );?></h3>
                        <div class="subtitle">
                            <span><?php esc_html_e( 'Human Resource Management', 'erp-pro' ); ?></span>
                            <label class="switch">
                ...
                <div class="module_item_col">
                    <div class="module_item crm">
                        <div class="icon">
                            <img src="<?php echo esc_url( ERP_PRO_PLUGIN_ASSEST . '/images/icons/crm.svg' ); ?>" alt="<?php echo esc_attr( 'CRM' ); ?>" />
                        </div>
                        <h3 class="title"><?php esc_html_e( 'CR Management', 'erp-pro' );?></h3>
                        <div class="subtitle">
                            <span><?php esc_html_e( 'Cusomer Relationship Management', 'erp-pro' ); ?></span>
                            <label class="switch">
                ...
                <div class="module_item_col">
                    <div class="module_item accounting">
                        <div class="icon">
                            <img src="<?php echo esc_url( ERP_PRO_PLUGIN_ASSEST . '/images/icons/accounting.svg' ); ?>" alt="<?php echo esc_attr( 'Accounting' ); ?>" />
                        </div>
                        <h3 class="title"><?php esc_html_e( 'Accounting', 'erp-pro' );?></h3>
                        <div class="subtitle">
                            <span><?php esc_html_e( 'Accounting Management', 'erp-pro' ); ?></span>
                            <label class="switch">
                ...
                <ul>
                    ...
                    <li>
                        <button id="purchased" class="btn active">
                            <img src="<?php echo esc_url( ERP_PRO_PLUGIN_ASSEST . '/images/icons/purchaged.svg' ); ?>" alt="<?php echo esc_attr( 'Purchased' ); ?>" />
                            <span><?php echo __( 'Purchased', 'erp-pro' ); ?></span>
                        </button>
                    </li>
                    <li>
                        <button id="hrm" class="btn">
                            <img src="<?php echo esc_url( ERP_PRO_PLUGIN_ASSEST . '/images/icons/hrm-colored.svg' ); ?>" alt="<?php echo esc_attr( 'HRM' ); ?>" />
                            <span><?php echo __( 'HRM', 'erp-pro' ); ?></span>
                        </button>
                    </li>
                    <li>
                        <button id="crm" class="btn">
                            <img src="<?php echo esc_url( ERP_PRO_PLUGIN_ASSEST . '/images/icons/crm-colored.svg' ); ?>" alt="<?php echo esc_attr( 'CRM' ); ?>" />
                            <span><?php echo __( 'CRM', 'erp-pro' ); ?></span>
                        </button>
                    </li>
                    <li>
                        <button id="accounting" class="btn">
                            <img src="<?php echo esc_url( ERP_PRO_PLUGIN_ASSEST . '/images/icons/accounting-colored.svg' ); ?>" alt="<?php echo esc_attr( 'Accounting' ); ?>" />
                            <span><?php echo __( 'Accounting', 'erp-pro' ); ?></span>
                        </button>
                    </li>
                ...
                <ul>
                    <li>
                        <button id="all" class="btn active">
                            <span><?php esc_html_e( 'All', 'erp-pro' ); ?></span>
                        </button>
                    </li>
                    <li>
                        <button id="active" class="btn">
                            <span><?php esc_html_e( 'Active', 'erp-pro' ); ?></span>
                        </button>
                    </li>
                    <li>
                        <button id="inactive" class="btn">
                            <span><?php esc_html_e( 'Inactive', 'erp-pro' ); ?></span>
                        </button>
                    </li>
                </ul>
            ...
            <ul>
                <li class="all-select">
                    <button>
                        ...
                        <label for="select_all"><?php esc_html_e( 'Select All', 'erp-pro' ); ?></label>
                    </button>
                </li>
                <li class="enable" data-action="activate">
                    <button>
                        <img class="state_normal" src="<?php echo esc_url( ERP_PRO_PLUGIN_ASSEST . '/images/icons/enable.svg' ); ?>" alt="<?php echo esc_attr( 'Enable' ); ?>" />
                        <img class="state_hover" src="<?php echo esc_url( ERP_PRO_PLUGIN_ASSEST . '/images/icons/enable-colored.svg' ); ?>" alt="<?php echo esc_attr( 'Enable' ); ?>" />
                        <span><?php esc_html_e( 'Activate', 'erp-pro' ); ?></span>
                    </button>
                </li>
                <li class="disable" data-action="deactivate">
                    <button>
                        <img class="state_normal" src="<?php echo esc_url( ERP_PRO_PLUGIN_ASSEST . '/images/icons/disable.svg' ); ?>" alt="<?php echo esc_attr( 'Disable' ); ?>" />
                        <img class="state_hover" src="<?php echo esc_url( ERP_PRO_PLUGIN_ASSEST . '/images/icons/disable-colored.svg' ); ?>" alt="<?php echo esc_attr( 'Disable' ); ?>" />
                        <span><?php esc_html_e( 'Deactivate', 'erp-pro' ); ?></span>
                    </button>
                </li>
                <li class="close">
                    <button id="close_table_nav_btn">
                        <img class="state_normal" src="<?php echo esc_url( ERP_PRO_PLUGIN_ASSEST . '/images/icons/close.svg' ); ?>" alt="<?php echo esc_attr( 'Disable' ); ?>" />
                        <img class="state_hover" src="<?php echo esc_url( ERP_PRO_PLUGIN_ASSEST . '/images/icons/close-colored.svg' ); ?>" alt="<?php echo esc_attr( 'Disable' ); ?>" />
                    </button>
                </li>
            </ul>
        </div>
    ...
    <div class="erp_addon_wrap">
        <?php
        $all_modules    = wp_erp_pro()->module->get_all_modules();
        ...
        <div class="erp_addon_row" id="view">
            ...
            <?php
            //echo "<pre>"; print_r( $active_modules ); echo "</pre>";
            foreach ( $all_modules as $module_id => $module ) {
                ...
                if ( in_array( $module->id, $active_modules ) && class_exists( $module->module_class ) ) {
                    ...
                    <div class="erp_addon">
                        ...
                        <div class="erp_addon_item_row erp_addon_item_row_bottom">
                            <div class="ext_cat">
                                ...
                                <?php } ?>
                                <a class="doc_link" href="<?php echo esc_url( $module->doc_link ); ?>" target="_blank"><?php esc_html_e( 'Docs', 'erp-pro' ); ?></a>
                            </div>
                            <div class="erp-links">
                                <?php
                                if ( $module->is_pro || in_array( $module->path, $my_modules ) ) {
                                    ...
                                    ?>
                                    <a href="<?php echo esc_url( $purchase_url ); ?>" class="button button-primary"  target="_blank" title="<?php _e( 'Get It', 'erp-pro' ); ?>" ><?php _e( 'Get It', 'erp-pro' ); ?></a>
                                    <?php
                                }
                                ?>
                            </div>
        ...
        <?php
            ...
            esc_html_e( '<div class="error"><p>Error fetching add-ons</p></div>', 'erp-pro' );
        }
        ?>
    </div>
</div>
...
<script type="text/javascript">
    jQuery( function( $ ) {
        ...
        $( '.module_action' ).click( function() {
            ...
            wp.ajax.send( 'erp-pro-toggle-module', {
                data: {
                    '_wpnonce': '<?php echo wp_create_nonce( 'wp-erp-pro-toggle-module' )  ?>',
                    module_id:  module_id,
                    toggle:     toggle
                },
