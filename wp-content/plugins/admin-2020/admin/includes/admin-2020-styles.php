...
class Admin_2020_Styles {
  ...
  public function admin2020_mailPoet_workaround($whitelistedStyles) {
      ...
      $requiredcss = array("ma-admin-color.min.css","ma-admin-common.min.css","ma-admin-head.min.css","ma-admin-menu.min.css","ma-admin-mobile.min.css","uikit.min.css","mailpoet.min.css");
  ...
  public function add_styles(){
    ...
    //LOAD UIKIT
    wp_register_style('uikitcss', 'https://cdn.jsdelivr.net/npm/uikit@3.5.8/dist/css/uikit.min.css', false);
    wp_enqueue_style('uikitcss');
    wp_enqueue_script('uikit', 'https://cdn.jsdelivr.net/npm/uikit@3.5.8/dist/js/uikit.min.js', array());
    wp_enqueue_script('uikiticons', 'https://cdn.jsdelivr.net/npm/uikit@3.5.8/dist/js/uikit-icons.min.js', array());
    ////LOAD CHART.JS
