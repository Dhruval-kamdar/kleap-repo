...
///REBUILD ADMIN MENU AND BAR
  ...
  ?>
  	...
  	<nav class="uk-navbar-container uk-navbar-transparent uk-background-default ma-admin-bar uk-padding uk-padding-remove-vertical" id="" uk-navbar>
  	    ...
  	    <div class="uk-navbar-right">
            ...
            <?php } ?>
                ...
                <li>
                  <a href="#">
                    <span class="" uk-icon="icon: bolt"></span>
                        ...
                        <div uk-dropdown="pos: bottom-right;" style="max-height: 600px;overflow: auto;padding:0 !important;z-index:1000;">
              ...
              <li uk-toggle="target: #offcanvas-notification-menu" style="position:relative">
  	            <a href="#" class="">
                  <span uk-icon="bell"></span>
                  <?php
                  if (!$utils->get_option('admin2020_flyout_update_link')){
                      if (!is_super_admin()) {
                        $totalupdates = 0;
                      } ?>
                      <span class="uk-badge uk-position-top-right-out admin2020notificationBadge uk-animation-slide-top" style="display:none;"><?php echo $totalupdates?></span>
                 <?php } ?>
                </a>
	            </li>
    ...
    <!-- OFFCANVAS NOTIFICATION MENU -->
  	<div id="offcanvas-notification-menu" uk-offcanvas="flip: true; overlay: true;">
  	    <div class="uk-offcanvas-bar" style="width:500px;max-width:100%">
          <button class="uk-offcanvas-close" type="button" uk-close></button>

          <?php
          if (is_super_admin() && !$utils->get_option('admin2020_flyout_update_link') && $totalupdates > 0){ ?>

            <div class="uk-h4 uk-margin-remove-top"><?php _e('Updates','admin2020')?></div>
          ...
          <div class="uk-h4 uk-margin-remove-top"><?php _e('Notifications','admin2020')?></div>
          <div id="admin2020_notification_center" class="ma-admin-dark" style="background:none;"></div>
        </div>
    </div>
    ...
    <!-- OFFCANVAS USER MENU -->
  	<div id="offcanvas-user-menu" uk-offcanvas="flip: true; overlay: true;">
  	    <div class="uk-offcanvas-bar">
  	        ...
  	        <div class="uk-h4 uk-margin-remove-top"><?=sprintf(__( '%s, %s', 'admin-2020' ), $greeting, $first_name)?></div>
