...
class Admin_2020_Media{
  ...
  public function run(){
    ...
    add_action( 'wp_enqueue_media', array($this,'admin2020_add_media_overrides'),99 );

    //add_filter('upload_mimes', array($this,'admin2020_allow_svg'));
    //add_filter( 'wp_check_filetype_and_ext', array($this,'admin2020_process_svg'),10,4);


  }

  public function admin2020_allow_svg($mimes) {
   $mimes['svg'] = 'image/svg+xml';
   return $mimes;
  }

  public function admin2020_process_svg($data, $file, $filename, $mimes){
  ...
  public function admin2020_add_media_overrides() {
      ...
      add_action('admin_enqueue_scripts', array( $this, 'add_media_styles' ),10);

  }

  public function add_media_styles(){

    if(!wp_style_is('ma-admin-media','enqueued')){
  ...
  public function admin_media_render() {
    ...
    <div uk-filter="target: .admin2020_media_gallery" id="admin2020_media_gallery_filter">
      ...
      <div class="uk-grid">
        ...
        <div class="uk-width-large@m uk-width-1-1@s" id="admin2020_mediapanel" <?php echo $open_closed?>>
        ...
        <div uk-grid="" class="admin2020_media_gallery uk-width-expand@m uk-width-1-1@s">
  ...
  public function admin2020_build_post_view($attachment_id){
    ...
    ?>
        ...
        <div class="uk-padding" style="float: left;position: relative;width: 100%;">
        ...
        <div class="uk-padding" style="padding-bottom:0;">
          ...
          <div class="uk-grid-small" uk-grid>
            ...
            <?php } ?>
            <div class="uk-width-auto"><a href="#" id="admin2020_duplicate_post" uk-icon="icon: copy" uk-tooltip="<?php _e('Duplicate','admin2020')?>" onclick="admin2020_duplicate_post()"></a></div>
            ...
            <div class="uk-width-auto">
                <a href="#" uk-icon="icon:chevron-left" onclick="switchinfo('left')"></a>
            </div>

            <div class="uk-width-auto">
                <a href="#" uk-icon="icon:chevron-right" onclick="switchinfo('right')"></a>
            </div>
        ...
        <ul class="uk-switcher uk-margin post_preview_switcher uk-padding" style="padding-top:0;max-height:300px;min-height: 300px;overflow:auto;">
        ...
        <div class="uk-padding uk-background-default" style="position:relative;padding-top:15px;padding-bottom:15px;border-top:1px solid rgba(162,162,162,0.2)">
          ...
          <div class="admin2020loaderwrap" id="admin2020_media_loader" style="display: none;top:0;left:0;">
          ...
          <?php if(current_user_can( 'delete_post' , $attachment_id)){ ?>
            <button class="uk-button uk-button-danger" type="button" onclick="admin2020_delete_attachment()"><span  uk-icon="icon:trash"></span></button>
          <?php } ?>
        </div>
    ...
    ?>
            ...
            <div class="uk-padding" style="float: left;position: relative;width: 100%">
              ...
              if (strpos($attachmenttype, 'image') !== false) {
                ...
                ?><div class="uk-padding" id="admin2020audioViewer" class="uk-align-center uk-margin-remove-bottom" style="width:100%;display:none;float:left">
                  <video id="admin2020audioplayer" src="<?php echo $attachment_url?>" playsinline controls uk-video="autoplay: false" style="border-radius:4px;max-height:350px;"></video>
                </div><?php
            ...
            <div class="uk-padding" style="padding-bottom:0;">
              ...
              <div class="uk-padding uk-background-default" style="position:relative;padding-top:15px;padding-bottom:15px;border-top:1px solid rgba(162,162,162,0.2)">
                ...
                <?php if(current_user_can( 'edit_post' , $attachment_id)){ ?>
                  <button class="uk-button uk-button-primary uk-align-right uk-margin-remove" type="button" onclick="admin2020_save_attachment(<?php echo $attachment_id?>)"><?php _e('Save','admin2020')?></button>
                <?php } ?>
                <?php if(current_user_can( 'delete_post' , $attachment_id)){ ?>
                  <button class="uk-button uk-button-danger" type="button" onclick="admin2020_delete_attachment()"><span  uk-icon="icon:trash"></span></button>
                <?php } ?>
  ...
  public function build_single_attachment($attachmentid){
    ...
    if (strpos($attachmenttype, 'image') !== false) {
      ...
      <div uk-drop="mode: hover;pos:bottom-justify;offset:0;" class="attachment_drop">
        <div class="uk-card uk-card-body uk-card-default uk-padding-small">
          <div class="uk-text-emphasis"><?php echo esc_html($attachment->post_title)?></div>
          <div class="uk-text-meta"><span uk-icon="cloud-upload" class="uk-margin-small-right"></span><?php echo _e('by','admin2020').' '.esc_html($user->display_name)?></div>
          <p class="uk-text-meta"><?php echo esc_html($attachment->post_excerpt)?></p>
        </div>
      </div>
      <?php
    } else if (strpos($attachmenttype, 'video') !== false) {
            ...
            <div class="uk-grid-collapse" uk-grid uk-filter="target: .attachments" style="max-height: 100%;overflow: auto;height:100%">
              <div class=" uk-padding" id="admin2020_settings_column" style="width:400px;">
                <div >
                  ...
                  <div style="float:left;margin-top:80px;width:100%;margin-bottom:30px;">
                  ...
                  <div class="uk-width-1-1 admin2020-media-modal">
                    <?php
