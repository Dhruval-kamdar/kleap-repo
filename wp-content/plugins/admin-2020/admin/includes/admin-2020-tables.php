...
class Admin_2020_Table_Actions {
  ...
  public function register_actions(){
    ...
    add_filter('WP_List_Table', array($this,'wp_list_pages_filter'));

    add_filter( 'plugin_row_meta' , array($this,'admin2020_add_settings_link'),10,2 );

  }

  public function wp_list_pages_filter($output) {
  ...
  public function admin2020_add_settings_link( $plugin_meta, $plugin_file_name ) {
