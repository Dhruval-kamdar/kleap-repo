...
//admin.php?page=myplugin%2Fmyplugin-admin-page.php
  ...
  public function total_posts($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s" id="total_posts" card-type='general'>
  ...
  public function total_pages($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s" id="total_pages" card-type='general'>
      <div class="uk-card uk-card-default uk-card-body">
  ...
  public function total_comments($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s" id="total_comments" card-type='general'>
      <div class="uk-card uk-card-default uk-card-body">
  ...
  public function recent_comments($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s" id="recent_comments" card-type='general'>
      <div class="uk-card uk-card-default uk-card-body">
  ...
  public function visitors_chart($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s"  id="visitors_chart" card-type='analytics'>
      <div class="uk-card uk-card-default uk-card-body">
  ...
  public function site_speed_chart($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s"  id="site_speed_chart" card-type='analytics'>
      <div class="uk-card uk-card-default uk-card-body">
  ...
  public function total_sessions($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s" id="total_sessions" card-type='analytics'>
      <div class="uk-card uk-card-default uk-card-body">
  ...
  public function total_site_speed($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s" id="total_site_speed" card-type='analytics'>
      <div class="uk-card uk-card-default uk-card-body">
        <div class="uk-text-emphasis">
  ...
  public function total_bounce_rate($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s" id="total_bounce_rate" card-type='analytics'>
      <div class="uk-card uk-card-default uk-card-body">
        <div class="uk-text-emphasis">
  ...
  public function session_duration($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s" id="session_duration" card-type='analytics'>
      <div class="uk-card uk-card-default uk-card-body">
        <div class="uk-text-emphasis">
  ...
  public function total_pageviews($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s" id="total_pageviews" card-type='analytics'>
      <div class="uk-card uk-card-default uk-card-body">
  ...
  public function sessions_by_country($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s" id="sessions_by_country" card-type='analytics'>
      <div class="uk-card uk-card-default uk-card-body">
  ...
  public function sessions_by_page($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s" id="sessions_by_page" card-type='analytics'>
      <div class="uk-card uk-card-default uk-card-body">
  ...
  public function sessions_by_referer($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s" id="sessions_by_referer" card-type='analytics'>
      <div class="uk-card uk-card-default uk-card-body">
  ...
  public function device_breakdown($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s" id="device_breakdown" card-type='analytics'>
      <div class="uk-card uk-card-default uk-card-body">
        ...
        <canvas id="device_visits" style="height:200px;" class="uk-margin-top"></canvas>
      </div>
    </div>
  ...
  public function most_commented_posts($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s" id="most_commented_posts" card-type='general'>
      <div class="uk-card uk-card-default uk-card-body">
  ...
  public function new_users($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s" id="new_users" card-type='general'>
      <div class="uk-card uk-card-default uk-card-body">
  ...
  public function system_info($startdate = null, $enddate = null){
    ...
    ?>
    <div class="uk-width-1-3@l uk-width-1-2@m uk-width-1-1@s" id="system_info" card-type='general'>
      <div class="uk-card uk-card-default uk-card-body">
