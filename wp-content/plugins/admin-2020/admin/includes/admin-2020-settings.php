...
class Admin_2020_Plugin_Options{
  ...
  public function __construct( $theversion ) {
	  ...
	  add_settings_field(
		...
		if (is_network_admin() || !is_multisite()){
			...
			add_settings_field(
				...
				esc_attr__( 'Product Licence Key:', 'admin2020' ),
		...
		add_settings_field(
	    'admin2020_hide_admin_bar_front_end',
	    esc_html__( 'Hide admin bar on front end?', 'admin2020' ),
	    array($this,'admin2020_hide_admin_bar_front_end_render'),
	    'admin2020_general_settings',
	    'admin2020_pluginPage_section'
	  );
	...
	public function admin2020_hide_admin_bar_front_end_render(  ) {

		$options = get_option( 'admin2020_settings' );
		if (isset($options['admin2020_hide_admin_bar_front_end'])){
			$value = $options['admin2020_hide_admin_bar_front_end'];
		} else {
			$value = 0;
		}
		?>
		<label class="admin2020_switch">
				<input type='checkbox' name='admin2020_settings[admin2020_hide_admin_bar_front_end]' <?php checked( $value, 1 ); ?> value='1'>
				<span class="admin2020_slider"></span>
		</label>
