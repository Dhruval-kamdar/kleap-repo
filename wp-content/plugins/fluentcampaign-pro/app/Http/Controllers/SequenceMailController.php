...
class SequenceMailController extends Controller
{
    ...
    public function get(Request $request, $sequenceId, $emailId)
    {
    ...
    public function create(Request $request, $sequenceId)
    {
        ...
        return $this->sendSuccess([
            'message' => __('Sequence email has been created', 'fluentcampaign'),
            'email'   => $email
        ]);
    }
    ...
    public function update(Request $request, $sequenceId, $emailId)
    {
        ...
        return $this->sendSuccess([
            'message' => __('Sequence email has been updated', 'fluentcampaign'),
            'email'   => $email
        ]);
    }
