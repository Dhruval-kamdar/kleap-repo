...
class WooOrderSuccessTrigger extends BaseTrigger
{
    ...
    {
        return [
            'title'     => 'New WooCommerce Order (Processing) has been places',
    ...
    private function isProcessable($funnel, $order, $subscriberData)
    {
        ...
        return Helper::isPurchaseTypeMatch($order, $purchaseType) && Helper::isProductIdCategoryMatched($order, $purchaseType);
    }
}
