...
class CustomSegment extends BaseSegment
{
    ...
    public function getSegments()
    {
        ...
        foreach ($segments as $segment) {
            ...
            $settings['contact_count'] = $this->getContactCount($settings);
    ...
    public function getInfo()
    {
        return [
            'slug'        => $this->slug,
            'is_system'   => false,
            'subtitle'    => 'Custom Segments with custom filters on Subscriber data',
            'description' => 'This is a custom segment and contacts are filter based your provided filters on real time data.'
        ];
    }
