            ...
            <div id="submitdiv" class="postbox <?php echo postbox_classes('submitdiv', get_current_screen()->id); ?>">
              ...
              <div class="inside">
                      ...
                      <div v-cloak>
                        ...
                        <div class="wpultimo-price wpultimo-price-first" style="margin-top: 10px; text-align: left;">
                          ...
                          <select id="menu_type" name="menu_type" v-model="menu_type" style="width: 100%" class="form-control">
                            <option <?php selected($admin_page->menu_type, 'menu'); ?> value="menu"><?php _e('Top-level Menu', 'wu-apc'); ?></option>
                            <option <?php selected($admin_page->menu_type, 'submenu'); ?> value="submenu"><?php _e('Submenu', 'wu-apc'); ?></option>
                            ...
                            <option <?php selected($admin_page->menu_type, 'widget'); ?> value="widget"><?php _e('Dashboard Widget', 'wu-apc'); ?></option>
                          </select>
                        ...
                        <div class="wpultimo-price wpultimo-price-first" style="text-align: left;" v-show="menu_type == 'replace'">
                          ...
                          <select id="page_to_replace" name="page_to_replace" v-model="page_to_replace" style="width: 100%" class="form-control">

                            <?php foreach ($menu_parent_list as $slug => $label) : ?>
                                <?php if (!is_numeric($label)) : ?>
                                <option <?php selected($admin_page->page_to_replace, $slug); ?> value="<?php echo $slug; ?>">
							                	  <?php echo wu_apc_remove_html_tags_and_content($label); ?>
                                </option>
                                <?php endif; ?>
                            <?php endforeach; ?>
                          ...
                          <div v-bind:class="true ? 'error' : ''">
                            <p><?php _e('There seems to be an error fetching your list of admin pages.', 'wu-apc'); ?> <?php printf('<a href="%s">%s</a>.', get_admin_url(1, '?flush_menu_and_submenus=1&redirect=' . urlencode("//{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}")), __('Click here to reset that list', 'wu-apc')); ?></p>
                          </div>
                          <?php endif; ?>
                        ...
                        <div class="wpultimo-price wpultimo-price-first" style="text-align: left;" v-show="menu_type == 'replace_submenu'">
                ...
                <?php endforeach; ?>
                        ...
                        <div class="wpultimo-price wpultimo-price-first" style="text-align: left;" v-if="menu_type == 'menu' || menu_type == 'submenu' || menu_type == 'replace' || menu_type == 'replace_submenu'">
