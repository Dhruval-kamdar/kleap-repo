...
class Cartflows_Pro_Checkout_Meta {
	...
	public function __construct() {
		...
		add_action( 'cartflows_product_options_tab_content', array( $this, 'tab_content_product_options' ), 10, 2 );
	 ...
	 * @param int   $post_id post ID.
	 */
	public function tab_content_pre_checkout_offer( $options, $post_id ) {
	 ...
	 * @param int   $post_id post ID.
	 */
	public function tab_style_pre_checkout_offer( $options, $post_id ) {
	 ...
	 * @param int   $post_id post ID.
	 */
	public function tab_content_product_bump( $options, $post_id ) {
	 ...
	 * @param int   $post_id post ID.
	 */
	public function tab_style_product_bump( $options, $post_id ) {
	 ...
	 * @param int   $post_id post ID.
	 */
	public function tab_content_checkout_design( $options, $post_id ) {
	 ...
	 */
	public function add_two_step_tab( $tabs, $active_tab ) {
	 ...
	 * @param int   $post_id post ID.
	 */
	public function tab_content_product_options( $options, $post_id ) {
		...
		$this->tab_style_for_highlight_product( $options, $post_id );
		?>
		</div>
		<?php
	 ...
	 * @param int   $post_id post id.
	 */
	public function tab_style_for_highlight_product( $options, $post_id ) {
