...
if ( 'subscription' === $price_sel_data['type'] ) {
	...
	$display_title     .= '<div class="wcf-display-subscription-details">';
		...
		$display_title .= '<span class="wcf_subscription_period">' . __( ' every ', 'cartflows-pro' ) . WC_Subscriptions_Product::get_interval( $rc_product_obj ) . ' ' . WC_Subscriptions_Product::get_period( $rc_product_obj ) . '</span>';
