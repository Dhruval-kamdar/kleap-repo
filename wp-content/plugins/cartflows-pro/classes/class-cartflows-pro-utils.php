...
class Cartflows_Pro_Utils {
	 ...
	 * @return array
	 */
	public function get_offer_data( $step_id, $selected_product_id = '', $input_qty = '' ) {
		$data               = array();
		$subscription_types = array( 'subscription', 'variable_subscription', 'subscription_variation' );
