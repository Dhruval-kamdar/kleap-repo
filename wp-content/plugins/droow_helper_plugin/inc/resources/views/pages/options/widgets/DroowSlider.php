...
class DroowSlider extends \Elementor\Widget_Base
{
    ...
    {
        $this->dsn_target_block = acf_get_block_type( 'acf/' . acf_slugify( 'dsnSlider' ) );
    ...
    protected function _register_controls()
    {
        ...
        $f = new DroowInFields();
        $f->getData( array(
            'dsn_group_key' => 'group_5e35dbe842aa0'
        ), $this );
...
//        dd($settings['style_box']);
        ...
        echo droow_shortcode_dsnSlider( $droow->getAttrBlock( null, $settings ), '' );
