...
class DroowBrand extends \Elementor\Widget_Base
{
    ...
    {
        $this->dsn_target_block =  acf_get_block_type('acf/' . acf_slugify('dsnBrand'));
    ...
    protected function _register_controls()
    {
        ...
        $f = new DroowInFields();
        $f->getData(array(
            'dsn_group_key' => 'group_5e3819387d91d'
        ) , $this);
...
//        $html = wp_oembed_get($settings['url']);
        ...
        echo droow_shortcode_brand($droow->getAttrBlock(null , $settings), $settings['item']);
