...
class DroowFeaturedPosts extends \Elementor\Widget_Base
{
    ...
    {
        $this->dsn_target_block = acf_get_block_type('acf/' . acf_slugify('dsn_featured_posts'));
    ...
    protected function _register_controls()
    {
        ...
        $f = new DroowInFields();
        $f->getData(array(
            'dsn_group_key' => 'group_5e468b4110d87'
        ), $this);
...
//        $html = wp_oembed_get($settings['url']);
        ...
        echo droow_shortcode_posts( $droow->getAttrBlock( null , $settings ) , $settings['item']  );
