...
class DroowService extends \Elementor\Widget_Base
{
    ...
    {
        $this->dsn_target_block = acf_get_block_type('acf/' . acf_slugify('dsn_service'));
    ...
    protected function _register_controls()
    {
        ...
        $f = new DroowInFields();
        $f->getData(array(
            'dsn_group_key' => 'group_5e36efc3bf3cd'
        ), $this);
...
//        dd($settings['style_box']);
        ...
        echo droow_shortcode_Service( $droow->getAttrBlock( null , $settings ) , $settings['item']  );
