...
class DroowTeam extends \Elementor\Widget_Base
{
    ...
    {
        $this->dsn_target_block = acf_get_block_type( 'acf/' . acf_slugify( 'dsnTeam' ) );
    ...
    protected function _register_controls()
    {
        ...
        $f = new DroowInFields();
        $f->getData( array(
            'dsn_group_key' => 'group_5e381e5d0a7d2'
        ), $this );
...
//        dd($settings['style_box']);
        ...
        echo droow_shortcode_team( $droow->getAttrBlock( null, $settings ), $settings[ 'item' ] );
