...
class DroowBoxGallery extends \Elementor\Widget_Base
{
    ...
    {
        $this->dsn_target_block = acf_get_block_type( 'acf/' . acf_slugify( 'dsnBoxGallery' ) );
...
//        dd($settings['style_box']);
        ...
        echo droow_shortcode_dsnBoxGallery( $droow->getAttrBlock( null, $settings ), droow_acf_option_array( $settings, 'image_size_popup' ) );
