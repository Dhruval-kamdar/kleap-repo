...
class DroowParagraph extends \Elementor\Widget_Base
{
    ...
    {
        $this->dsn_target_block =  acf_get_block_type('acf/' . acf_slugify('dsn_paragraph'));
    ...
    protected function _register_controls()
    {
        ...
        $f = new DroowInFields();
        $f->getData(array(
            'dsn_group_key' => 'group_5e34825620756'
        ) , $this);
...
//        $html = wp_oembed_get($settings['url']);
        ...
        echo droow_shortcode_paragraph($droow->getAttrBlock(null , $settings) , '');
