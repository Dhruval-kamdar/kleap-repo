...
class DroowParallaxImage extends \Elementor\Widget_Base
{
    ...
    {
        $this->dsn_target_block = acf_get_block_type( 'acf/' . acf_slugify( 'parallaxImage' ) );
    ...
    protected function _register_controls()
    {
        ...
        $f = new DroowInFields();
        $f->getData( array(
            'dsn_group_key' => 'group_5e2f2ed8140a6'
        ), $this );
...
//        dd($settings['style_box']);
        ...
        echo droow_shortcode_parallaxImage( $droow->getAttrBlock( null, $settings ), '' );
