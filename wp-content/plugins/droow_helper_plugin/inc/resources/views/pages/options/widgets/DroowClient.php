...
class DroowClient extends \Elementor\Widget_Base
{
    ...
    {
        $this->dsn_target_block = acf_get_block_type('acf/' . acf_slugify('dsnClient'));
    ...
    protected function _register_controls()
    {
        ...
        $f = new DroowInFields();
        $f->getData(array(
            'dsn_group_key' => 'group_5e37431175f67'
        ), $this);
...
//        dd($settings['style_box']);
        ...
        echo droow_shortcode_client( $droow->getAttrBlock( null , $settings ) , $settings['item']  );
