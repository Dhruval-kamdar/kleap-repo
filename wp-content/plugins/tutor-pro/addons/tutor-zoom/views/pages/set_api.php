    ...
    <form id="tutor-zoom-settings" action="">
        ...
        <div class="tutor-zoom-form-container">
            <div class="input-area">
                ...
                <p><?php _e('Visit your Zoom account and fetch the API key to connect Zoom with your eLearning website. Create an app on Zoom by following this'); ?><a href="https://marketplace.zoom.us/develop/create" target="_blank"> <?php _e('link', 'tutor-pro'); ?></a></p>
