    ...
    public function monitor_notice()
    {
        ...
        if ($this->is_installed() && $this->is_connected() && !$this->monitoring_enabled()) {
            ...
            echo '<div class="notice notice-info is-dismissible ph-notice" data-notice="ph-jetpack-monitor-notice">
				...
				<p>' . esc_html(__("Please enable Jetpack's monitoring feature to ensure emails send on time!", 'project-huddle')) . ' <a href="https://help.projecthuddle.com/article/223-why-do-we-recommend-jetpacks-downtime-monitoring" data-beacon-article-modal="5dcdc48e2c7d3a7e9ae3f9b7">' . __('Why?', 'project-huddle') . '</a></p>' .
