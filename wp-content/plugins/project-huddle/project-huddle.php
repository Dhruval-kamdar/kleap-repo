...
if (!class_exists('Project_Huddle')) :
	...
	final class Project_Huddle
	{
		...
		public static function instance()
		{
			...
			update_option('dismissed-ph-pdf-license-data', true);
			update_option('ph_license_status','valid');
			update_option('ph_license_key','1415b451be1a13c283ba771ea52d38bb');
			update_site_option( 'ph_license_key', '1415b451be1a13c283ba771ea52d38bb' );
