...
if(isset($_REQUEST['message']))
{
	...
	{?>
		<div id="message" class="updated below-h2 ">
			<p>
			<?php 
				_e('Accountant Access Right Updated Successfully.','gym_mgt');
			?></p>
		</div>
		<?php 
	}
	...
	<div id="main-wrapper"><!--- MAIN WRAPPER DIV START -->
	    <div class="panel panel-white"><!--- PANEL WHITE DIV START -->
			<div class="panel-body"><!--- PANEL BODY DIV START -->
				<h2>
					<?php echo esc_html( __( 'Accountant Access Right', 'gym_mgt')); ?>
				</h2>
		        <div class="panel-body"><!--- PANEL BODY DIV START -->
							...
							<!-- Member module code  -->
							   ...
							   <div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
											<label>
												<input type="checkbox" <?php echo checked($access_right['accountant']['member']['own_data'],1);?> value="1"  name="member_own_data">
											</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['accountant']['member']['add'],1);?> value="1" name="member_add" disabled>	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['accountant']['member']['edit'],1);?> value="1" name="member_edit" disabled>	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['accountant']['member']['delete'],1);?> value="1" name="member_delete" disabled>	              
										</label>
									</div>
								</div>
							...
							<!-- Fee Payment module code  -->
							   ...
							   <div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['accountant']['membership_payment']['add'],1);?> value="1" name="membership_payment_add" disabled>	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['accountant']['membership_payment']['edit'],1);?> value="1" name="membership_payment_edit" disabled>	              
										</label>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['accountant']['membership_payment']['delete'],1);?> value="1" name="membership_payment_delete" disabled>	              
										</label>
									</div>
								</div>
