					...
					<div class="table_row">
						...
						<div class="col-md-7 col-sm-12 table_td">
							<span class="txt_color">
								<?php echo chunk_split($user_info->first_name." ".$user_info->middle_name." ".$user_info->last_name,28,"<BR>");?> 
							</span>
						</div>
					</div>
					<div class="table_row">
						...
						<div class="col-md-7 col-sm-12 table_td">
							<span class="txt_color"><?php echo chunk_split($user_info->user_email,28,"<BR>");?></span>
						</div>
					</div>
					<div class="table_row">
						<div class="col-md-5 col-sm-12 table_td">
	    ...
	    <div class="col-md-4 col-sm-12 member_right">	
			...
			<div class="table_row">
				<div class="col-md-6 col-sm-12 table_td">
					...
					<?php _e('MemberShip','gym_mgt');?>
				</div>
				<div class="col-md-6 col-sm-12 table_td">
				   <?php $membership_name=MJ_gmgt_get_membership_name($user_info->membership_id);   ?>
			...
			<div class="table_row">
				<div class="col-md-6 col-sm-12 table_td">
					...
					<?php _e('Status','gym_mgt');?>
				</div>
				<div class="col-md-6 col-sm-12 table_td">
					
					<span class="txt_color"><?php echo  _e($user_info->membership_status,'gym_mgt');?></span>
				</div>
			</div>
			<div class="table_row">
				<div class="col-md-6 col-sm-12 table_td">
					<i class="fa fa-calendar"></i>
					<?php _e('Expire Date','gym_mgt');?>
				</div>
				<div class="col-md-6 col-sm-12 table_td">
					<span class="txt_color"><?php if($user_info->member_type!='Prospect'){ echo MJ_gmgt_getdate_in_input_box(MJ_gmgt_check_membership($user_info->ID)); }else{ echo "--"; }?></span>
				</div>
			</div>
			<div class="table_row">
					<div class="col-md-6 col-sm-12 table_td">
					...
					<div class="col-md-6 col-sm-12 table_td">
						<span class="txt_color"><?php 
							if($user_info->address != '')
							 {
								echo chunk_split($user_info->address.", <BR>",18);
							 }
							 
							if($user_info->city_name != '')
							{
								echo chunk_split($user_info->city_name.", <BR>",18);
							}
...
<div class="panel-body"><!--PANEL BODY DIV START-->
		...
		<div class="col-md-6  col-sm-6  col-xs-12 border">
			<span class="report_title">
				...
				<a href="?dashboard=user&page=workouts&tab=addmeasurement&&action=insert&&user_id=<?php echo $_REQUEST['member_id'];?>&result_measurment=Weight" 
				class="btn btn-danger right"> <?php _e('Add Weight','gym_mgt');?></a>	
			</span>
			<?php 
			$weight_data = $obj_gyme->MJ_gmgt_get_weight_report('Weight',$_REQUEST['member_id']);
		...
		<div class="col-md-6  col-sm-6  col-xs-12 border borderleft">
			<span class="report_title">
				...
				<a href="?dashboard=user&page=workouts&tab=addmeasurement&&action=insert&&user_id=<?php echo $_REQUEST['member_id'];?>&result_measurment=Waist" 
				class="btn btn-danger right"> <?php _e('Add Waist','gym_mgt');?></a>		
			</span>
			<?php 
			$waist_chart = $obj_gyme->MJ_gmgt_get_weight_report('Waist',$_REQUEST['member_id']);
		...
		<div class="col-md-6  col-sm-6  col-xs-12 border">
			<span class="report_title">
				...
				<a href="?dashboard=user&page=workouts&tab=addmeasurement&&action=insert&&user_id=<?php echo $_REQUEST['member_id'];?>&result_measurment=Height" 
				class="btn btn-danger right"> <?php _e('Add Height','gym_mgt');?></a>	
			</span>
			<?php 
			$height_data = $obj_gyme->MJ_gmgt_get_weight_report('Height',$_REQUEST['member_id']);
		...
		<div class="col-md-6  col-sm-6  col-xs-12 border borderleft">
			<span class="report_title">
				...
				<a href="?dashboard=user&page=workouts&tab=addmeasurement&&action=insert&&user_id=<?php echo $_REQUEST['member_id'];?>&result_measurment=Chest" 
				class="btn btn-danger right"> <?php _e('Add Chest','gym_mgt');?></a>	
			</span>
			<?php 
			$chest_data = $obj_gyme->MJ_gmgt_get_weight_report('Chest',$_REQUEST['member_id']);
		...
		<div class="col-md-6  col-sm-6  col-xs-12 border">
			<span class="report_title">
				...
				<a href="?dashboard=user&page=workouts&tab=addmeasurement&&action=insert&user_id=<?php echo $_REQUEST['member_id'];?>&result_measurment=Thigh" 
				class="btn btn-danger right"> <?php _e('Add Thigh','gym_mgt');?></a>	
			</span>
			<?php 
			$thigh_data = $obj_gyme->MJ_gmgt_get_weight_report('Thigh',$_REQUEST['member_id']);
		...
		<div class="col-md-6  col-sm-6  col-xs-12 border borderleft">
			<span class="report_title">
				...
				<a href="?dashboard=user&page=workouts&tab=addmeasurement&&action=insert&user_id=<?php echo $_REQUEST['member_id'];?>&result_measurment=Arms" 
		...
		<div class="col-md-6  col-sm-6  col-xs-12 border">
			<span class="report_title">
				...
				<a href="?dashboard=user&page=workouts&tab=addmeasurement&&action=insert&user_id=<?php echo $_REQUEST['member_id'];?>&result_measurment=Fat" 
				class="btn btn-danger right"> <?php _e('Add Fat','gym_mgt');?></a>	
			</span>
			<?php 
			$fat_data = $obj_gyme->MJ_gmgt_get_weight_report('Fat',$_REQUEST['member_id']);
		...
		<div class="col-md-6  col-sm-6  col-xs-12 border borderleft viewmember_image_height" >
			<span class="report_title">
				...
				<!-- Slides Container -->
				<div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 250px; height: 250px;
			...
			<table id="subscription_list" class="display" cellspacing="0" width="100%"><!--TABLE SUBSCRIPTIOBN LIST START-->
				...
				if(!empty($paymentdata))
				{
					...
					<tr>
						...
						<td class="paid_amount"><?php echo $retrieved_data->paid_amount;?></td>
						...
						echo MJ_gmgt_get_membership_paymentstatus($retrieved_data->mp_id);
						echo "</span>";
						?>
						</td>
					</tr>
