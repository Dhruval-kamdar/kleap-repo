...
//define('EMAIL_ADD', 'maulik.patel@dasinfomedia.com'); // define any notification email
define('EMAIL_ADD', get_option('gmgt_email')); // define any notification email
...
define('PAYPAL_EMAIL_ADD', get_option('gmgt_paypal_email')); // facilitator email which will receive payments change this email to a live paypal account id when the site goes live
