...
<script async src="<?php echo Pages::asset( 'Accounts', 'js/fsp-change-fb-poster.js' ); ?>"></script>
	...
	<div class="fsp-modal-step">
		...
		<div class="fsp-form-group">
			<label class="fsp-is-jb">
				<?php echo fsp__( 'Select a Facebook page to share your posts in Facebook groups on behalf of the page. Note that the page has to be linked to the group; otherwise, the post will fail.' ); ?>
			</label> <select id="fspjs-page-id" class="fsp-form-select">
