	...
	<div class="fsp-modal-step">
		<div class="fsp-form-group">
			<label class="fsp-is-jb">
				<?php echo fsp__( 'Enter the website URL' ); ?>
				<a href="https://www.fs-poster.com/documentation/fs-poster-auto-publish-wordpress-posts-to-your-wp-site" target="_blank" class="fsp-tooltip" data-title="<?php echo fsp__( 'How to?' ); ?>"><i class="far fa-question-circle"></i></a>
			</label>
			<div class="fsp-form-input-has-icon">
				<i class="far fa-copy"></i>
				<input id="fspWP_site_url" autocomplete="off" class="fsp-form-input" placeholder="<?php echo fsp__( 'Enter the website URL' ); ?>">
			</div>
		</div>
		<div class="fsp-form-group">
			<label><?php echo fsp__( 'Enter the username' ); ?></label>
			<div class="fsp-form-input-has-icon">
				<i class="far fa-copy"></i>
				<input id="fspWP_username" autocomplete="off" class="fsp-form-input" placeholder="<?php echo fsp__( 'Enter the username' ); ?>">
			</div>
		</div>
		<div class="fsp-form-group">
			<label><?php echo fsp__( 'Enter the password' ); ?></label>
			<div class="fsp-form-input-has-icon">
				<i class="far fa-copy"></i>
				<input id="fspWP_password" autocomplete="off" class="fsp-form-input" placeholder="<?php echo fsp__( 'Enter the password' ); ?>">
			</div>
		</div>
	</div>
