...
<script async src="<?php echo Pages::asset( 'Accounts', 'js/fsp-accounts-medium.js' ); ?>"></script>
<script>
	fspConfig.standartAppURL = '<?php echo Helper::standartAppRedirectURL( 'medium' ); ?>';
</script>
	...
	<div class="fsp-modal-step">
		<div class="fsp-form-group">
			<label class="fsp-is-jb">
				...
				<a href="https://www.fs-poster.com/documentation/fs-poster-schedule-auto-publish-wordpress-posts-to-medium" target="_blank" class="fsp-tooltip" data-title="<?php echo fsp__( 'How to?' ); ?>"><i class="far fa-question-circle"></i></a>
				...
				{ ?>
					<option disabled><?php echo fsp__( 'There isn\'t a Medium App!' ); ?></option>
				<?php } ?>
			</select>
		</div>
	</div>
