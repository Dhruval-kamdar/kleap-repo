	...
	<div class="fsp-vk-steps">
		<div class="fsp-form-group fsp-vk-step" data-step="1">
			<label class="fsp-is-jb">
				...
				<a href="https://www.fs-poster.com/documentation/fs-poster-schedule-share-wordpress-posts-to-vk-automatically" target="_blank" class="fsp-tooltip" data-title="<?php echo fsp__( 'How to?' ); ?>"><i class="far fa-question-circle"></i></a>
			</label> <select class="fsp-form-select" id="fspModalAppSelector">
				...
				{ ?>
					<option disabled><?php echo fsp__( 'There isn\'t a VKontakte App!' ); ?></option>
				<?php } ?>
			</select>
		</div>
		...
		<div class="fsp-form-group fsp-vk-step" data-step="3">
			<?php echo fsp__( 'When the authorization has completed, copy the URL' ); ?>
		</div>
		<div class="fsp-form-group fsp-vk-step" data-step="4">
			<label><?php echo fsp__( 'URL' ); ?></label>
			<textarea id="fspAccessToken" class="fsp-form-textarea" placeholder="<?php echo fsp__( 'Paste the copied URL here' ); ?>"></textarea>
		</div>
	</div>
	<div class="fsp-vk-steps">
