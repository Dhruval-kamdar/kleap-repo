...
<script async src="<?php echo Pages::asset( 'Accounts', 'js/fsp-accounts-ok.js' ); ?>"></script>
<script>
	fspConfig.standartAppURL = '<?php echo Helper::standartAppRedirectURL( 'ok' ); ?>';
</script>
	...
	<div class="fsp-modal-step">
		<div class="fsp-form-group">
			<label class="fsp-is-jb">
				...
				<a href="https://www.fs-poster.com/documentation/fs-poster-auto-publish-wordpress-posts-to-odnoklassniki" target="_blank" class="fsp-tooltip" data-title="<?php echo fsp__( 'How to?' ); ?>"><i class="far fa-question-circle"></i></a>
