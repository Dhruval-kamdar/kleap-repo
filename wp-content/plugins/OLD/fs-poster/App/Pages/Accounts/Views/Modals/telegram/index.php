			...
			<div class="fsp-card fsp-account-item" data-id="<?php echo $account_info[ 'id' ]; ?>" data-type="account">
				<div class="fsp-account-inline">
					...
					<div class="fsp-account-nodes-count">
						<?php echo $account_info[ 'chats' ]; ?>&nbsp;<?php echo fsp__( 'Chats' ); ?>
					</div>
					<?php if ( $account_info[ 'status' ] !== 'error' ) { ?>
						<button type="button" class="fsp-button" data-load-modal="telegram_add_chat" data-parameter-account_id="<?php echo (int) $account_info[ 'id' ] ?>"><?php echo fsp__( 'ADD A CHAT' ); ?></button>
					<?php } ?>
				</div>
				<div class="fsp-account-inline">
					<?php if ( $account_info[ 'status' ] === 'error' ) { ?>
