...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		<div class="fsp-settings-label-text"><?php echo fsp__( 'Share WordPress tags as Tumblr tags' ); ?></div>
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'Enable the option to add the WordPress tags to the Tumblr tag section.' ); ?></div>
	</div>
	<div class="fsp-settings-col">
		<div class="fsp-toggle">
			<input type="checkbox" name="fs_tumblr_send_tags" class="fsp-toggle-checkbox" id="fs_tumblr_send_tags" <?php echo Helper::getOption( 'tumblr_send_tags', '0' ) ? 'checked' : ''; ?>>
			<label class="fsp-toggle-label" for="fs_tumblr_send_tags"></label>
		</div>
	</div>
</div>
	...
	<div class="fsp-settings-collapse">
		<div class="fsp-settings-col">
			...
			<div class="fsp-custom-post" data-preview="fspCustomPostPreview">
				<textarea name="fs_post_text_message_tumblr" class="fsp-form-textarea"><?php echo esc_html( Helper::getOption( 'post_text_message_tumblr', "{title}" ) ); ?></textarea>
			...
			<div class="fsp-settings-preview">
				...
				<div class="fsp-settings-preview-footer">
					...
					<div class="fsp-settings-preview-info">
						...
						<span id="fspCustomPostPreview" class="fsp-settings-preview-info-text"><?php echo esc_html( Helper::getOption( 'post_text_message_tumblr', "{title}" ) ); ?></span>
					</div>
				</div>
			</div>
		</div>
