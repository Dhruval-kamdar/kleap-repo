...
<div class="fsp-settings-row">
	...
	<div class="fsp-settings-col">
		<select name="fs_facebook_posting_type" id="fs_facebook_posting_type" class="fsp-form-select">
			<option value="1" <?php echo Helper::getOption( 'facebook_posting_type', '1' ) == '1' ? 'selected' : ''; ?>><?php echo fsp__( 'Link card view' ); ?></option>
			<option value="2" <?php echo Helper::getOption( 'facebook_posting_type', '1' ) == '2' ? 'selected' : ''; ?>><?php echo fsp__( 'Upload featured image only' ); ?></option>
			<option value="3" <?php echo Helper::getOption( 'facebook_posting_type', '1' ) == '3' ? 'selected' : ''; ?>><?php echo fsp__( 'Upload all post images' ); ?></option>
		</select>
	</div>
</div>
			...
			<div class="fsp-settings-preview">
				...
				<div class="fsp-settings-preview-footer">
					...
					<div class="fsp-settings-preview-info">
						...
						<span id="fspCustomPostPreview" class="fsp-settings-preview-info-text"><?php echo esc_html( Helper::getOption( 'post_text_message_fb', "{title}" ) ); ?></span>
					</div>
				</div>
			</div>
		</div>
