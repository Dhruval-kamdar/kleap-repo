...
<div class="fsp-settings-row">
	...
	<div class="fsp-settings-col">
		<select name="fs_twitter_posting_type" id="fs_twitter_posting_type" class="fsp-form-select">
			...
			<option value="2" <?php echo Helper::getOption( 'twitter_posting_type', '1' ) == '2' ? 'selected' : ''; ?>><?php echo fsp__( 'Upload featured image only' ); ?></option>
			<option value="3" <?php echo Helper::getOption( 'twitter_posting_type', '1' ) == '3' ? 'selected' : ''; ?>><?php echo fsp__( 'Upload all post images' ); ?></option>
		</select>
	</div>
</div>
