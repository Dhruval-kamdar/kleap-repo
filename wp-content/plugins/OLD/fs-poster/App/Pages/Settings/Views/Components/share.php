...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		...
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'If you don\'t want to keep the shared post logs, you need to disable the option. Disabling the option prevents you view your insights.' ); ?></div>
	</div>
	<div class="fsp-settings-col">
		<div class="fsp-toggle">
...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		<div class="fsp-settings-label-text"><?php echo fsp__( 'Replace the white spaces in the tags with an underscore' ); ?></div>
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'Enable the option to replace the whitespaces with underscores in keyword of {tags} and {categories} ( e.g., "Sport News" will be transformed to "#sport_news" ). Disable the option to remove the whitespaces in keyword of {tags} and {categories} ( e.g., "Sport News" will be transformed to "#sportnews" ).' ); ?></div>
	</div>
	<div class="fsp-settings-col">
		<div class="fsp-toggle">
